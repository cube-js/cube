...
export CUBEJS_DB_SNOWFLAKE_AUTHENTICATOR=SNOWFLAKE_JWT
export CUBEJS_DB_SNOWFLAKE_PRIVATE_KEY=$DRIVERS_TESTS_SNOWFLAKE_CUBEJS_DB_PRIVATE_KEY
export CUBEJS_DB_SNOWFLAKE_PRIVATE_KEY_PASS=$DRIVERS_TESTS_SNOWFLAKE_CUBEJS_DB_PRIVATE_KEY_PASS
