...
[ref-schema-ref-measure-types-avg]:
  /reference/data-model/types-and-formats#avg
[ref-schema-ref-measure-types-count]:
  /reference/data-model/types-and-formats#count
[ref-schema-ref-measure-types-max]:
  /reference/data-model/types-and-formats#max
[ref-schema-ref-measure-types-min]:
  /reference/data-model/types-and-formats#min
[ref-schema-ref-measure-types-sum]:
  /reference/data-model/types-and-formats#sum
