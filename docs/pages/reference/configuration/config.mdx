...
[ref-schema-cube-ref-ctx-sec-ctx]:
  /reference/data-model/cube#security-context
...
[ref-exec-environment-globals]:
  /product/data-modeling/dynamic/schema-execution-environment#node-js-globals-process-env-console-log-and-others
