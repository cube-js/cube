...
and also outputting it to the console of the Vector agent in your Cube deployment.
...
variables</Btn> page of your Cube deployment:
    ...
    measures:
      ...
      - name: count_non_production
        description: |
          ...
          See for details: https://cube.dev/docs/cube/workspace/environments
        type: count
        filters:
...
[ref-query-history-export]: /cube/workspace/monitoring#query-history-export
[ref-query-history]: /cube/workspace/query-history
[ref-vector-configuration]: /cube/workspace/monitoring#configuration