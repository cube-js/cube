...
and spreadsheet integrations, i.e., [Cube for Sheets][ref-sheets-integration]
and [Cube for Excel][ref-excel-integration].

<SuccessBox>

Saved Reports are available in Cube on
...
You can create a report in [Cube for Sheets][ref-sheets-integration] or [Cube
...
[ref-rbac]: /cube/workspace/access-control#managing-roles