...
The Pre-Aggregations page in Cube allows you to inspect all
...
The Pre-aggregations page is available in Cube on
...
[ref-model-ref-preaggs-partition-granularity]:
  /product/data-modeling/reference/pre-aggregations#partition_granularity
