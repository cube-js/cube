...
The <Btn>Encryption Keys</Btn> page in Cube allows to manage [data-at-rest
encryption in Cube Store][ref-cube-store-encryption].

<SuccessBox>

Data-at-rest encryption in Cube Store is available in Cube on the
...
Navigate to <Btn>Settings → Encryption Keys</Btn> in your Cube deployment
...
[ref-pre-aggs-build-manually]: /cube/workspace/pre-aggregations
