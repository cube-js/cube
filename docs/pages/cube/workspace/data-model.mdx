...
Data model editor is available in Cube on
[all product tiers](https://cube.dev/pricing).

</SuccessBox>

Cube can create branch-based development API instances to quickly test
...
you've been editing a data model and navigate away, Cube will warn you if
...
To add more Git branches to your Cube deployment and/or switch between
...
where you can quickly test things in Cube without having to go through a
CI/CD process.
