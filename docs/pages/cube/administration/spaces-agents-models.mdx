...
**Agent Spaces** are isolated environments where AI agents operate and share context, rules, and [memories](/cube/administration/memory-isolation). Think of them as "workspaces" or "projects" that contain everything an agent needs to work effectively.
...
1. **Setup**: Create a space and configure [agent rules](/cube/administration/agent-rules)
