...
into the
[`repositoryFactory`](/product/configuration/reference/config#repositoryfactory)
function.
...
names via the
[`scheduledRefreshContexts`](/product/configuration/reference/config#scheduledrefreshcontexts)
