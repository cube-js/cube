...
[definition](/reference/data-model/pre-aggregations#measures).
...
[`count_distinct_approx` type](/reference/data-model/types-and-formats#count_distinct_approx)
...
[calculated measures](/reference/data-model/measures#calculated-measures)
