...
<Diagram
  ...
  src="https://ucarecdn.com/41d8e12f-d5f8-47e4-9a73-4025568d1300/"
/>
...
to `users`. One possible solution is to move the `users → organization_users`
join from `organization_users` cube to `users`, although this affects the query
