...
| --- | --- |
| `timestamp`, `date`, `time` | [`time`](/product/data-modeling/reference/types-and-formats#time-1) |
| `text`, `varchar` | [`string`](/product/data-modeling/reference/types-and-formats#string-1) |
| `integer`, `bigint`, `decimal` | [`number`](/product/data-modeling/reference/types-and-formats#number-1) |
| `boolean` | [`boolean`](/product/data-modeling/reference/types-and-formats#boolean-1) |
...
[ref-ref-time-dimensions]: /product/data-modeling/reference/types-and-formats#time-1
