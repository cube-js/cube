...
We recommend to migrate over to [Explore](/product/exploration/explore) and [Workbooks](/product/exploration/workbooks) for data analysis in exploration in Cube cloud platform.
...
[ref-data-model-title]: /product/data-modeling/reference/measures#title
[ref-data-model-description]: /product/data-modeling/reference/measures#description
[ref-data-model-public]: /product/data-modeling/reference/measures#public
