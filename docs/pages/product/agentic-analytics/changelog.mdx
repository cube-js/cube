...
Learn more in the [Chat Embed docs](/product/apis-integrations/embedding).
...
Learn more in the [Source SQL docs](/product/workspace/workbooks#source-sql).
...
Learn more in the [Dashboards docs](/product/workspace/workbooks#dashboards).
...
Learn more in the [Chart Templates docs](/product/workspace/workbooks#chart-templates).
...
Learn more in the [Table Chart docs](/product/workspace/workbooks#table-chart).
...
Learn more in the [AI docs](/product/workspace/chats-history).
