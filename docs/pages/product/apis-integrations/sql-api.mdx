...
Queries that Cube runs against to your database will always be aggregated,
...
An equivalent aggregated query must aggregate all measure columns and group by
