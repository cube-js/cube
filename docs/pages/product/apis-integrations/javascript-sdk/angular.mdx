...
**Modules.** Inject
[CubejsClientModule](/reference/frontend/cubejs-client-vue#query-builder) and
[CubejsClient](/reference/frontend/cubejs-client-vue#query-renderer) into your
...
- **Query data from Cube Backend and Transform data for visualization.** Use
  [CubejsClient](/reference/frontend/cubejs-client-ngx#api) to load data. The
