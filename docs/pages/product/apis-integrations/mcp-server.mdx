...
The previous local MCP server uses API keys and the Chat API URL and is considered legacy. If you still need it for a self-managed setup, see the open-source example on GitHub:

[https://github.com/cube-js/cube/tree/master/examples-demos/simple-mcp-server](https://github.com/cube-js/cube/tree/master/examples-demos/simple-mcp-server)
