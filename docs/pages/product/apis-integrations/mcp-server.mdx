...
Cube MCP (Model Context Protocol) lets MCP-compatible AI clients connect to Cube over HTTPS using OAuth. It is hosted by AI Engineer, so you don’t need to run a local MCP server or manage API keys.
