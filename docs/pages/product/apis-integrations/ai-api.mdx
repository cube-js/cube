...
The AI API currently requires [views](/product/data-modeling/reference/view) in order to generate queries. This is because:
...
The AI API can read [meta tags](/product/data-modeling/reference/view#meta) on your dimensions, measures, 
segments, and views.
