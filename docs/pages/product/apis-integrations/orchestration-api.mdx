...
For [partitioned pre-aggregations][ref-pre-agg-partitions], all partitions will
be rebuilt.

<ReferenceBox>

Currently, rebuilding only select partitions is not supported.
Please [track this issue](https://github.com/cube-js/cube/issues/6722).

</ReferenceBox>


[ref-scheduled-refresh]: /reference/data-model/pre-aggregations#scheduled_refresh
...
[ref-ref-jobs-endpoint]: /product/apis-integrations/rest-api/reference#v1pre-aggregationsjobs
