...
To use the MDX API, set up one or more views before getting started.

#### Dimension hierarchies

MDX API supports dimension hierarchies. You can define multiple hierarchies in the view's schema file.
