...
Copy the exact Chat API URL from your agent settings.

<InfoBox>

The Chat API base URL is **dynamic**. Copy the exact Chat API URL from your agent settings (**Chat API URL** field) in <Btn>Admin → Agents</Btn>.
