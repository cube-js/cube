...
[type of the dimension](/reference/data-model/types-and-formats#dimension-types).
...
[ref-schema-ref-preaggs-dimensions]:
  /reference/data-model/pre-aggregations#dimensions
...
[ref-ungrouped-query]: /product/data-modeling/queries#ungrouped-query