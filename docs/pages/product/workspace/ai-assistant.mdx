...
Then, follow the Getting Started steps from the Catalog page to connect your data assets.

Once you're done, navigate to your deployment's AI Assistant tab and ask your first question!
