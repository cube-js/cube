...
By default, only active staging environments are accessible. To make a staging environment linked to a specific branch always accessible,
you need to toggle the switch for this branch on the Staging Environments page in Settings.
<Screenshot
