...
All roles will be available under `cloud.roles` array in the [security context][ref-security-context]:
...
All mapped attributes and their values will be available under `cloud.userAttributes`
