...
<Screenshot
  src="https://ucarecdn.com/5949a9c7-3e28-40bc-b71c-c0564957190e/"
  alt="Build and deploy tab"
/>
...
To open Visual Modeler, click on the <Btn>Show Canvas</Btn> in the top right of the Data Model
page. Visual Modeler will stay open until you go back to the code editor by clicking
the <Btn>View Code</Btn> button or <Btn>Show Code</Btn> on any cube or view node.
