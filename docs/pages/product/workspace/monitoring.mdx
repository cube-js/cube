...
Monitoring integrations are available in Cube Cloud on [Enterprise](https://cube.dev/pricing) plan.
Users can choose a [Monitoring Integrations tier](/product/deployment/cloud/pricing#monitoring-integrations-tiers).
