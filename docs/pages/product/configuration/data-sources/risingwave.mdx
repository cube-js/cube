...
| <EnvVar>CUBEJS_DB_SSL</EnvVar>      | If `true`, enables [SSL encryption](https://docs.risingwave.com/docs/current/secure-connections-with-ssl-tls/) for database connections from Cube | `true`, `false`           |    ❌    |
