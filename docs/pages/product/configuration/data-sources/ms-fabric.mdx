...
[Enterprise](https://cube.dev/pricing) tier. [Contact
...
under <Btn>Name</Btn> and the server name under <Btn>SQL connection string</Btn>:

<Screenshot src="https://ucarecdn.com/7818f783-4bd6-431c-87dd-c5169232c91b/"/>

If your SQL connection string is `<SERVER_NAME>.datawarehouse.fabric.microsoft.com`,
then use just `<SERVER_NAME>`.
