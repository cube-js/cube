...
In order to connect Cube to Snowflake, you need to grant certain permissions to the Snowflake role used by Cube. Cube requires the role to have **USAGE** on the Databases and Schemas
and **SELECT** on the Tables. An example configuration:
```
