...
Snowflake supports using [AWS S3][aws-s3], [Google Cloud
Storage][google-cloud-storage], and [Azure Blob Storage][azure-blob-storage] for export bucket functionality.
