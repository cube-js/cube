...
Data source drivers enable the connectivity to upstream data sources and provide
the support for various [data source-specific features][ref-driver-features].
...
[ref-driver-features]: /product/configuration/data-sources/features
