...
* Runs a single Production Cluster that is active 12 hours a day, 5 days a week,
has auto-suspension enabled with an 1-hour threshold, and never auto-scales its
API instances because the usage is spread evenly with no bursts.
* Operates on a small volume of data that requires the usage of just 2 Cube Store
Workers to run queries and refresh pre-aggregations during working hours.
...
5 days a week in the development mode of the Production Cluster.

| Resource                                        | Usage per month                                                                                   | CCU per month                    | Cost per month                                             |
| ----------------------------------------------- | ------------------------------------------------------------------------------------------------- | -------------------------------- | ---------------------------------------------------------- |
| Production Cluster                              | 1 Production Cluster ×<br/>(12 + 1) hours per day ×<br/>5 days per week ×<br/>4.4 weeks per month | 286 hours ×<br/>4 CCUs per hour  | 1144 CCUs ×<br/>\$&thinsp;0.25 per CCU = **\$&thinsp;286** |
| Additional Cube API Instance                    | —                                                                                                 | —                                | —                                                          |
| Cube Store Worker                               | 2 Cube Store Workers ×<br/>(12 + 1) hours per day ×<br/>5 days per week ×<br/>4.4 weeks per month | 572 hours ×<br/>1 CCU per hour   | 572 CCUs ×<br/>\$&thinsp;0.25 per CCU = **\$&thinsp;143**  |
| Development Instance                            | —                                                                                                 | —                                | —                                                          |
| Development Instance<br/>(for development mode) | 2 users ×<br/>1 hour per day ×<br/>5 days per week ×<br/>4.4 weeks per month                      | 44 hours ×<br/>1 CCU per hour    | 44 CCUs ×<br/>\$&thinsp;0.25 per CCU = **\$&thinsp;11**    |
| **Total**                                       |                                                                                                   |                                  | **\$&thinsp;440**                                          |
...
* Runs two Production Clusters that are active 24/7, never auto-suspend, and auto-scale
up to 8 API instances during a peak hour every day.
...
5 days a week, and has auto-suspension enabled with an 1-hour threshold.
* Has a team of 5 data engineers who frequently update the data model, with each data engineer
spending about 4 hours a day, 5 days a week in the development mode of the dedicated
Development Instance.

| Resource                                        | Usage per month                                                                                                         | CCU per month                    | Cost per month                                             |
| ----------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | -------------------------------- | ---------------------------------------------------------- |
| Production Cluster                              | 2 Production Clusters ×<br/>24 hours per day ×<br/>7 days per week ×<br/>4.4 weeks per month                            | 1478 hours ×<br/>4 CCUs per hour | 5912 CCUs ×<br/>\$&thinsp;0.4 per CCU = **\$&thinsp;2365** |
| Additional Cube API Instance                    | 2 Production Clusters ×<br/>(8 – 2) API Instances ×<br/>1 hour per day ×<br/>7 days per week ×<br/>4.4 weeks per month  | 370 hours ×<br/>1 CCU per hour   | 370 CCUs ×<br/>\$&thinsp;0.4 per CCU = **\$&thinsp;148**   |
| Cube Store Worker                               | 2 Production Clusters ×<br/>4 Cube Store Workers ×<br/>12 hours per day ×<br/>7 days per week ×<br/>4.4 weeks per month | 2959 hours ×<br/>1 CCU per hour  | 2959 CCUs ×<br/>\$&thinsp;0.4 per CCU = **\$&thinsp;1184** |
| Development Instance                            | 1 Development Instance ×<br/>(12 + 1) hours per day ×<br/>5 days per week ×<br/>4.4 weeks per month                     | 286 hours ×<br/>1 CCU per hour   | 286 CCUs ×<br/>\$&thinsp;0.4 per CCU = **\$&thinsp;114**   |
| Development Instance<br/>(for development mode) | 5 users ×<br/>4 hours per day ×<br/>5 days per week ×<br/>4.4 weeks per month                                           | 440 hours ×<br/>1 CCU per hour   | 440 CCUs ×<br/>\$&thinsp;0.4 per CCU = **\$&thinsp;176**   |
| **Total**                                       |                                                                                                                         |                                  | **\$&thinsp;3987**                                         |
