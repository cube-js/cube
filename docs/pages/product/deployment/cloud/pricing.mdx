...
AI API and AI Assistant consume CCUs per request apart from Enterprise+ who can provide their own suitable LLM if wanted and then will not consume CCUs to use either:
