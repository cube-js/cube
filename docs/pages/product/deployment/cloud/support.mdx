...
with **3 questions per month** through the in-product chat feature.
...
* Enterprise plan also includes a **dedicated customer support manager** (CSM)
...
* Enterprise Premier plan also includes a **dedicated customer support manager** (CSM)
who will provide quarterly reviews, sharing new features and training as well
as usage and optimization advice.
