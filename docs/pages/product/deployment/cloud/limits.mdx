...
Queries processed volume and their data retention depend on the Query History tier for the deployment.
Usage is calculated per Cube Cloud deployment.
Query History processing has the following tiers.

| Tier                      | Data retention period | API requests / day |
| ------------------------- | --------------------- | ------------------ |
| XS                        |                 1 day |             50,000 |
| S                         |                7 days |            100,000 |
| M                         |               14 days |            250,000 |
