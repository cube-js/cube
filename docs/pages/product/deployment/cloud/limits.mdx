...
| Queries per day ([production cluster][ref-prod-cluster])        |     —     |  50,000   | Depends on [Query History tier][ref-query-history-tiers] | Depends on [Query History tier][ref-query-history-tiers] | Depends on [Query History tier][ref-query-history-tiers] |
