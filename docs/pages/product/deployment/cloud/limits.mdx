...
| Queries per day for each [development instance][ref-dev-instance]                   |   1,000   |  10,000   | Depends on [Query History tier][ref-query-history-tiers] | Depends on [Query History tier][ref-query-history-tiers] | Depends on [Query History tier][ref-query-history-tiers] |
| Queries per day for each [production cluster][ref-prod-cluster]                     |     —     |  50,000   | Depends on [Query History tier][ref-query-history-tiers] | Depends on [Query History tier][ref-query-history-tiers] | Depends on [Query History tier][ref-query-history-tiers] |
| Queries processed by [Query History][ref-query-history] per day for each deployment |   1,000   |  50,000   | Depends on [Query History tier][ref-query-history-tiers] | Depends on [Query History tier][ref-query-history-tiers] | Depends on [Query History tier][ref-query-history-tiers] |
