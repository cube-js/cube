...
[ref-schema-ref-measure-types-avg]:
  /product/data-modeling/reference/types-and-formats#avg
[ref-schema-ref-measure-types-count]:
  /product/data-modeling/reference/types-and-formats#count
[ref-schema-ref-measure-types-max]:
  /product/data-modeling/reference/types-and-formats#max
[ref-schema-ref-measure-types-min]:
  /product/data-modeling/reference/types-and-formats#min
[ref-schema-ref-measure-types-sum]:
  /product/data-modeling/reference/types-and-formats#sum
