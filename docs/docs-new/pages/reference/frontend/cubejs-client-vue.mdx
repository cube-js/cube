...
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| cubejsApi              | [CubejsApi](/reference/frontend/cubejs-client-core#cubejsapi)                                                                                 | `CubejsApi` instance to use                                                                                                                                                                                                        |
...
- `resultSet`: A `resultSet` is an object containing data obtained from the
  query. [ResultSet](/reference/frontend/cubejs-client-core#result-set) object
...
| Name       | Type                                                  |
| ---------- | ----------------------------------------------------- |
| query      | [Query](/reference/frontend/cubejs-client-core#query) |
...
| -------------------------- | ------------------------------------------------------------------ |
| chartType?                 | [ChartType](#types-chart-type)                                     |
| pivotConfig?               | [PivotConfig](/reference/frontend/cubejs-client-core#pivot-config) |
