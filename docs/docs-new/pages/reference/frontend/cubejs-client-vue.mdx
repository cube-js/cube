...
| query?                 | Query                                                                                                                                         | Query parameters ([learn more about the format](/product/api-rest/query-format)). This property is reactive - if you change the object here, the internal query values will be overwritten. This is not two-way. |
