...
[REST API](/reference/rest-api) base path. The default value is `/cubejs-api`.
...
[ref-caching-up-to-date]: /product/caching/overview#keeping-cache-up-to-date
...
[ref-rest-api-sched-refresh]: /reference/rest-api#v-1-run-scheduled-refresh
...
[ref-schema-ref-preaggs-rollup]:
  /product/data-modeling/reference/pre-aggregations#type-rollup
[ref-sec]: /product/auth/overview
...
[ref-schema-ref-datasource]: /product/data-modeling/reference/cube#data-source
...
[ref-rest-scopes]: /product/api-rest/overview#configuration-api-scopes
