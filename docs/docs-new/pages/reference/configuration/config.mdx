...
necessary security contexts prior to running the scheduled refreshes. Can
be asynchronous.
...
on each request. Can be asynchronous.
...
This configuration option is deprecated and will likely be removed in
future versions of Cube.
