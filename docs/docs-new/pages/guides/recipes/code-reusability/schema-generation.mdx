...
feature][ref-export-import].

Please refer to the
[`asyncModule()`](/product/data-modeling/advanced/schema-execution-environment#async-module)
...
[ref-export-import]:
  /product/data-modeling/advanced/code-reusability-export-and-import
