...
environment before releasing any changes to production. When development mode is
enabled, a new set of API endpoints is deployed specifically for the branch on a
[Development Instance][ref-deploy-cloud-types-devinstance], and is charged
according to the [Development Instance pricing][ref-deploy-cloud-pricing].
...
[ref-deploy-cloud-pricing]: /product/deployment/cloud/pricing
[ref-deploy-cloud-types-devinstance]:
