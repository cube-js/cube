...
Now go to your Bitbucket repository and on the <Btn>Clone</Btn> dialog, switch
to <Btn>SSH</Btn> and copy the URL:
...
settings. Click <Btn>Access keys</Btn> from the navigation, then click  <Btn>Add
key</Btn> button. Give the key a label (`Cube Cloud`, for example) and paste the
...
click <Btn>Connect</Btn>. After a connection is successfully established, you
...
Paste the URL into the correct field, ensure the <Btn>Repository > Push</Btn>
trigger is checked and click <Btn>Save</Btn>.
