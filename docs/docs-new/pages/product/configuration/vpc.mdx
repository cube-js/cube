...
<Grid imageSize={[56, 56]} cols={2}>
  <GridItem
    ...
    imageUrl="https://raw.githubusercontent.com/cube-js/cube.js/master/docs/static/icons/aws.svg"
    title="Amazon Web Services"
  />
  <GridItem
    url="connecting-with-a-vpc/gcp"
    imageUrl="https://raw.githubusercontent.com/cube-js/cube.js/master/docs/static/icons/gcp.svg"
    title="Google Cloud Platform"
  />
  <GridItem
    url="connecting-with-a-vpc/azure"
    imageUrl="https://raw.githubusercontent.com/cube-js/cube.js/master/docs/static/icons/azure.svg"
