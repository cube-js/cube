...
Use the
[`data_source`](/product/data-modeling/reference/cube#parameters-data-source)
...
[ref-config-ref-driverfactory]:
  /reference/configuration/config#options-reference-driver-factory
[ref-config-db]: /product/configuration/data-sources
[ref-config-multitenancy]:
  /product/configuration/advanced/multitenancy#multitenancy-multitenancy-vs-multiple-data-sources
...
- Ensure you have the correct
  [multitenancy](/product/configuration/advanced/multitenancy) configuration in
  your `cube.js` file.
