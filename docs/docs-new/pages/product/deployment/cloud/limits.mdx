...
production cluster. Alternatively, consider upgrading to [another
tier][ref-pricing].

### Queries processed by Query History per day

This is a soft limit. When a threshold is hit, query processing will be stopped.
Please [contact support][cube-contact-us] for further assistance.
