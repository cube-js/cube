...
2.  Click <Btn>Applications > Applications</Btn> from the navigation on the left
    ...
    select <Btn>SAML</Btn> and click <Btn>Next</Btn>.
...
From under <Btn>Settings > Sign on methods > SAML</Btn>, click <Btn>More
details</Btn>:
...
2.  On the <Btn>Authentication & SSO</Btn> tab, scroll down to <Btn>SAML</Btn>
    and copy the <Btn>Single Sign On URL</Btn> value:
