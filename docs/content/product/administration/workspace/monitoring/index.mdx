...
You can also choose a [Monitoring Integrations tier](/product/administration/pricing#monitoring-integrations-tiers).
...
tier](/product/administration/pricing#monitoring-integrations-tiers).
...
refresh scheduler, use the <EnvVar>CUBEJS_LOG_LEVEL</EnvVar> environment variable.
...
Requires the [M tier](/product/administration/pricing#monitoring-integrations-tiers)
