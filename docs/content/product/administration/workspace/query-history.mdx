...
You can also choose a [Query History tier](/product/administration/pricing#query-history-tiers).
...
Clicking <Btn>Accelerate</Btn> allows you to add a pre-aggregation to
