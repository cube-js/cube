...
You can also choose an [Audit Log tier](/product/administration/pricing#audit-log-tiers).
...
| [Custom roles](/product/administration/users-and-permissions/custom-roles) | `Created role`<br/>`Deleted role`<br/>`Updated role`<br/>`Assigned role to user`<br/>`Assigned roles to user`<br/>`Removed role from user` |
