...
styling, borders, titles, and fonts — using the <Btn>Styling</Btn> pane in the
Dashboard Builder. Open your dashboard, click <Btn>Dashboard Builder</Btn> in the
top bar, then click the gear icon to open the <Btn>Styling</Btn> panel.
