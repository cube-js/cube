...
[ref-query-history]: /product/administration/monitoring/query-history#inspecting-api-queries
[ref-perf-insights]: /product/administration/monitoring/performance#cache-type
