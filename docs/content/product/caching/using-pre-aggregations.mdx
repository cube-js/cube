...
<EnvVar>CUBEJS_ROLLUP_ONLY</EnvVar> environment variable.
...
[ref-flame-graph]: /product/administration/monitoring/query-history#flame-graph
[ref-perf-insights]: /product/administration/monitoring/performance
[ref-build-history]: /product/administration/monitoring/pre-aggregations#build-history
