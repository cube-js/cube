...
- *Soft limit* allows further use of a resource after a threshold is hit but
this further usage consume additional [Cube Compute Units][ref-pricing].
...
This is a soft limit. When a threshold is hit, further queries yield
additional CCU consumption. [Contact us][cube-contact-us] to get a quote.
