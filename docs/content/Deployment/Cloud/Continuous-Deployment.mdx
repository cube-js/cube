...
Enabling this option will cause the Schema tab to display the last known state of a Git-based codebase (if available), instead of reflecting the latest modifications made.
