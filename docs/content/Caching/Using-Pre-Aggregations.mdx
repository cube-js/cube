...
Cube supports three different strategies for building pre-aggregations.
To see which strategies your database supports, please refer to it's individual
page from [Connecting to the Database][ref-config-db].
