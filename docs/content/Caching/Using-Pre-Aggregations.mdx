...
Although `zip_code` may have lower or higher selectivity, the dimensions used to filter must come first than the dimensions in the GROUP BY part of the query.
