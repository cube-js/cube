...
### <--{"name" : "More metrics for Sessions"}--> Number of Events per Session
...
### <--{"name" : "More metrics for Sessions"}--> Bounce Rate
...
### <--{"name" : "More metrics for Sessions"}--> First Referrer
...
### <--{"name" : "More metrics for Sessions"}--> Sessions New vs Returning
...
### <--{"name" : "More metrics for Sessions"}--> Filter Sessions, where user performs specific event
