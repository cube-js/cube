  ...
  - name: users
    ...
    measures:
      ...
      - name: ratio
        ...
        sql: "1.0 * {number_of_people_of_any_gender_in_the_city} / {total_number_of_women}"
        type: number
...
cube(`users`, {
  ...
  measures: {
    ...
    ratio: {
      title: 'Ratio Women in the City to Total Number of People',
      sql: `1.0 * ${CUBE.number_of_people_of_any_gender_in_the_city} / ${CUBE.total_number_of_women}`,
      type: `number`,
    },
  },
