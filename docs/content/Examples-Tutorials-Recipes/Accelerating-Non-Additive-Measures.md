...
### <--{"name" : "Data schema"}-->  Replacing with approximate additive measures
...
### <--{"name" : "Data schema"}-->  Decomposing into a formula with additive measures
...
### <--{"name" : "Data schema"}-->  Providing multiple pre-aggregations
