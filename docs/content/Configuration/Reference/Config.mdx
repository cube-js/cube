...
This option allows to customize the repository for Cube data schema files. It is
...
Schema version can be used to tell Cube schema should be recompiled in case
