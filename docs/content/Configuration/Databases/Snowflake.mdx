...
| `CUBEJS_DB_SNOWFLAKE_SCHEMA`                    | The Snowflake schema to use when connecting to the database                                                                                         | [A valid Snowflake schema][snowflake-docs-schema] in the account       |    ❌    |                                    ✅                                    |
