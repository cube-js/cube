...
<WarningBox>
  The driver for MongoDB is <a href="../databases#driver-support">community-supported</a> and is not supported by Cube or the vendor. 
</WarningBox>
...
used in pre-aggregations when using MongoDB as a source database.
