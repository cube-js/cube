...
<InfoBox>
  ...
  please [file an issue](https://github.com/cube-js/cube/issues) on
  GitHub. You can also contribute a driver, see this [step-by-step guide](https://github.com/cube-js/cube/blob/master/CONTRIBUTING.md#implementing-driver).
...
<Grid imageSize={[56, 56]}>
  ...
  />
  <GridItem
    url="databases/singlestore"
    imageUrl="https://seeklogo.com/images/S/singlestore-logo-CBD32FECEE-seeklogo.com.png"
    title="SingleStore"
  />
</Grid>
