...
<InfoBox>
  ...
  Most of the drivers for data sources on this page are supported either directly by Cube Dev or via individual vendors. Rest are community supported and those drivers will be listed under the <em>Community supported</em> section. 
</InfoBox>
