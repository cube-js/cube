...
Note that Cube also supports connecting to [multiple data stores][ref-config-multi-data-src] out of the box.
...
Setup step in deployment creation, or from&nbsp;<Btn>Settings → Configuration</Btn> in your
deployment.
