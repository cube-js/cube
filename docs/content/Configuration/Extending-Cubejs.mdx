...
<InfoBox heading={`Running Cube.js in Docker`}>

When installing custom Node.js packages for Cube.js running in Docker container,
...
We do not recommend embedding Cube.js into existing Express application to share
the runtime. Cube.js should be scaled very differently vs. other parts of
Express, and embedding Cube.js **is not** the right approach in the long term,
