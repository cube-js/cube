...
A comma-separated list of data source names. Data sources defined here
can be used to [decorate `CUBEJS_DB_*`][ref-config-multiple-ds-decorating-env] environment variables.
