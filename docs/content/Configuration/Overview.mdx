...
Cube can be configured in two ways. The first is through [options][link-config] in a configuration
file, commonly known as the `cube.js` file, and secondly, through
