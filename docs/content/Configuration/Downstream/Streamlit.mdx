...
You can connect to Cube from Streamlit using the [Cube SQL API][ref-sql-api]. Streamlit turns data scripts into shareable web apps in minutes.
...
These credentials will be required to connect to Cube from Streamlit
later.
...
You can write SQL in Streamlit that will be executed in Cube. Learn more about Cube SQL
