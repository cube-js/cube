...
<LoomVideo url="https://www.loom.com/embed/eae86cdeb6c94546b0e7ad93e2fb3c8a" />
...
Because you saved the data source as `HOST/cubejs-api/v1`, don't forget to add a `/load` endpoint to the end of the data source API.
