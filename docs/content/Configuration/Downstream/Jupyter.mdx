...
You can connect to Cube from Jupyter using the [Cube SQL API][ref-sql-api]. The Jupyter Notebook is the original web application for creating and sharing computational documents.
