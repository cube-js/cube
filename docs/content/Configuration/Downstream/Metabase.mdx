...
Metabase. Semantic Layer Sync automatically synchronizes the
[data model][ref-data-model] with datasets in Metabase.

<SuccessBox>

Cube Cloud [has a dedicated page][ref-workspace-sls] to menage Semantic Layer
...
notification. You can ignore such emails, create an email rule to delete them,
or use a service account with a different email address:
