...
test changes in the data model in your frontend applications before pushing
...
specific to this branch. This development API hot-reloads your data model changes,
...
deployment creation. The <Btn>Generate Data Model</Btn> on the <Btn>Data Model</Btn>
page will let you re-generate models from your source database, or alternatively
add rollups to existing data models:
