...
The SQL Runner also allows executing queries using a specific security context,
which is particularly convenient for debugging queries that rely on specific
claims in a JWT, for example. The SQL Runner can be configured to use predefined
