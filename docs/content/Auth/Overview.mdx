...
<div style="text-align: center">
  <img
    src="https://ucarecdn.com/f364caf0-68fd-4312-8098-90308c2c6e46/"
    style="border: none"
    width="80%"
  />
</div>
...
username and password. In Cube, the [`checkSqlAuth()`][ref-conf-ref-conf-check-sql-auth] configuration option is
...
[ref-conf-ref-conf-check-sql-auth]: /config#check-sql-auth
