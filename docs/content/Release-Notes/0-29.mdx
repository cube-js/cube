...
releaseLink: https://github.com/cube-js/cube/releases/tag/v0.29.0
---
...
- Async client generation support in Angular
  ([Find an example here](https://github.com/cube-js/cube/tree/master/examples/dynamic-angular-dashboard))
