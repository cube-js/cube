...
releaseLink: https://github.com/cube-js/cube.js/releases/tag/v0.27.0
---
...
[_one_ deprecation this release relating to Redis configuration options](https://github.com/cube-js/cube.js/blob/master/DEPRECATION.md#prefix-redis-environment-variables-with-cubejs_);
