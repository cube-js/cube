...
A database name exposed by the [SQL API][ref-sql-api].
Used by [Semantic Layer Sync][ref-sls] to configure BI tools.
...
A host name of the instance running the [SQL API][ref-sql-api].
Used by [Semantic Layer Sync][ref-sls] to configure BI tools.
