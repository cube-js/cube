...
Cube can be configured using environment variables. When running Cube locally,
these can be set in a `.env` file in the root of the project. [In Cube
Cloud][ref-conf-ov-cloud], these can be set in the
deployment's&nbsp;<Btn>Settings</Btn> screen.

This page lists all environment variables that can be used to configure Cube.
...
<InfoBox heading="Example: Specifying two data sources">
...
<InfoBox heading="Example: Specifying an export bucket">
...
<InfoBox heading="Example: Specifying an export bucket for a specific data source">
...
<InfoBox heading="Example: Specifying an export bucket type">
...
<InfoBox heading='Example: Specifying an export bucket type for a specific data source'>
...
<InfoBox heading="Example: Disabling Cube telemetry">
...
<InfoBox heading="Example: Configuring the minIO server endpoint">
...
<InfoBox heading="Example: Specifying multiple Cube Store worker address/port pairs">
...
[ref-conf-ov-cloud]: /configuration/overview#cube-cloud
