---
title: 'Getting Started with Cube Cloud: Import GitHub repository'
permalink: /cloud/getting-started/github
---

This guide walks you through setting up Cube Cloud and connecting your Cube
project to your database.
...
Next up, click the **Import from a GitHub repository** button. This will pop
open a GitHub app authorization dialog where you must first install the Cube
