...
substantially improve the reliability, performance, and security:
...
* __Integrations:__ Optimized Databricks driver, optimized Elasticsearch driver, support for Azure blob storage in Cube Store, integration with monitoring solutions.
