...
First, `Cube Cloud tenant` must be added to your organization. To do this,
...
After you made sure that all information is correct, select `Consent on behalf of your organization` And click `Accept`
