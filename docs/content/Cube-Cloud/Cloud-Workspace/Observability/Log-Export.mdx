...
[sinks.loki]
  ...
  auth = { strategy = "basic", user = "$CUBE_CLOUD_LOG_EXPORT_LOKI_USER", password = "$CUBE_CLOUD_LOG_EXPORT_LOKI_PASS" }
  encoding = { codec = "json" }
  labels = { app = "cube-cloud", env = "production" }
...
[sinks.loki_cubestore]
  ...
  auth = { strategy = "basic", user = "$CUBE_CLOUD_LOG_EXPORT_LOKI_USER", password = "$CUBE_CLOUD_LOG_EXPORT_LOKI_PASS" }
  encoding = { codec = "json" }
  labels = { app = "cube-store", env = "production" }
