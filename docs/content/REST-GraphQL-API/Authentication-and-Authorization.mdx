...
<div style="text-align: center">
  <img
    src="https://ucarecdn.com/571b0dd4-3fb1-4e26-a5a6-c26e309d0e31/"
    style="border: none"
    width="80%"
  />
</div>
...
JWT using either [`CUBEJS_API_SECRET`][ref-conf-ref-env-api-secret], or using JSON Web Key Sets (JWKS) if
configured.
...
created and saved in the `.env` file as [`CUBEJS_API_SECRET`][ref-conf-ref-env-api-secret]. This secret key
...
[`CUBEJS_JWK_URL`][ref-conf-ref-env-jwk-url] or [`jwt.jwkUrl` is specified][ref-conf-ref-conf-jwt].
...
[`checkAuth()`][ref-conf-ref-conf-check-auth] function in the `cube.js` configuration
...
[ref-conf-ref-conf-check-auth]: /config#check-auth
[ref-conf-ref-conf-jwt]: /config#options-reference-jwt
[ref-conf-ref-env-api-secret]: /reference/environment-variables#cubejs-api-secret
[ref-conf-ref-env-jwk-url]: /reference/environment-variables#cubejs-jwk-url
