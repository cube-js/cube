---
title: 'Import a GitHub repository to Cube Cloud'
permalink: /cloud/getting-started/github
---

This guide walks you through setting up Cube Cloud, importing a GitHub
...
Click the <Btn>Create Deployment</Btn> button. This is the first step in the
...
Next up, click the <Btn>Import from a GitHub repository</Btn> button. This will
pop open a GitHub app authorization dialog where you must first install the Cube
Cloud GitHub app to the desired organization. After authorizing Cube Cloud to
access your GitHub repository, you should see the following screen in Cube
Cloud:
...
the database tables to generate the data schema from, then hit
<Btn>Generate</Btn>.
