---
title: 'Import a GitLab repository to Cube Cloud'
...
click&nbsp;<Btn>Add key</Btn>. Go back to Cube Cloud and
...
project's&nbsp;<Btn>Webhooks</Btn> settings. Paste the URL into the correct
field, ensure the&nbsp;<Btn>Push events</Btn> trigger is checked and
click&nbsp;<Btn>Add webhook</Btn>.
...
the database tables to generate the data schema from, then
