...
To get started with Cube Core, first we'll create a new project, connect it
to a database and generate a data model from it. Then, we'll run queries using the
...
- [Generate a data model from a connected data source](/getting-started/core/generate-models)
