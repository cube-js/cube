---
title: Query from BI
permalink: /getting-started/cloud/query-from-BI
...
Semantic Layer Sync programmatically connects a BI tool to Cube and creates or updates BI-specific entities
that correspond to entities within the data model in Cube, such as cubes, views, measures, and dimensions.
...
Replace the fields for user, password, and URL with your Superset credentials, then click on "Save All". 
You can now go to the "BI Integrations" page and trigger the synchronization of your newly created semantic layer.
...
![mapping-superset-to-cube](https://ucarecdn.com/24543165-34ef-4687-aeac-298aa29bacd5/)
...
![superset-example](https://ucarecdn.com/fd8e69e6-0a01-4ed9-8deb-848efb8a7e7f/)
