...
You can find your REST API endpoint on the “Overview” page. In development mode, Cube creates an isolated endpoint for testing data model changes without affecting production. 
