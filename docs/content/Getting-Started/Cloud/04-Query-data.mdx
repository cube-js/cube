...
Since the SQL API is Postgres-compatible, please make sure to select&nbsp;<Btn>Postgres</Btn> as the database type when [connecting from BI tools][ref-downstream].
