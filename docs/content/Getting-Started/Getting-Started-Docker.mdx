...
Consider exposing `3000` port if you're planing to work with dashboard app:
...
start modeling your data. You can [learn more about Cube.js Data
Schema][ref-cubejs-schema] for complex data modeling techniques.

Learn how to query Cube.js with [REST API][ref-rest-api], [SQL API][ref-sql-api] or [use our Javascript
