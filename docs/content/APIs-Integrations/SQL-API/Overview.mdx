...
the&nbsp;<Btn>Overview</Btn> page by
clicking&nbsp;<Btn>Connect to SQL API</Btn>.

You can also customize `CUBEJS_PG_SQL_PORT`, `CUBEJS_SQL_USER`,
and `CUBEJS_SQL_PASSWORD` environment variables by navigating
to&nbsp;<Btn>Settings → Configration</Btn>.
