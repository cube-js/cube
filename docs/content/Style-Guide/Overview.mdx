...
* A cube's name should represent business entiity and be plural. If a cube's name may clash with a view's name, add the `base_` prefix to the cube's name, e.g., `base_opportunities.yml`.
