...
YAML modelling is currently in Preview, and the syntax may change in a future
version.
...
The syntax for YAML modelling is very similar to the existing JavaScript syntax,
...
Instead of destructuring properties from
[`COMPILE_CONTEXT`][ref-schema-ref-cube-compile-ctx], use dot-notation to
specify the property directly:
