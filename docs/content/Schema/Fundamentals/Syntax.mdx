...
Cube enables you to reference existing objects in SQL blocks with Python-like `{}` interporlation syntax in YAML models and `${}` interporlation operator in JS models.
