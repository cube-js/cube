...
Cube also supports aggregating indexes that contain **only** any specified
...
1. They cannot make use of any `filters`
2. **All** dimensions in the query must be defined in the aggregating index
