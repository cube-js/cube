...
<InfoBox>
We are planning to support more languages for Data Modeling in Cube. <br />
  <a href="https://forms.gle/wM1dLgP5uiM7D7VPA">
    Please let us know which one you'd like to see next!
  </a>
</InfoBox>
