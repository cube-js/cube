...
Cube Cloud is available as [managed service](https://cubecloud.dev/auth/signup) and through "bring your own
cloud" model. [Please contact us](https://cube.dev/contact) if you'd like to
install Cube Cloud within your AWS, GCP, or Azure account.
