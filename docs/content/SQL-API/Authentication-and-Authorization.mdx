...
<div style="text-align: center">
  <img
    src="https://ucarecdn.com/7fb6959f-1d45-404b-939d-0e66e9207a6c/"
    style="border: none"
    width="80%"
  />
</div>
...
username and password. In Cube, the [`checkSqlAuth()`][ref-config-check-sql-auth] configuration option is
