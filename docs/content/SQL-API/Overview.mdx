...
The above SQL query will be translated into the following Cube query.
...
When querying cube tables it is important to understand fundamentals of transformation query fragments into Cube queries as wel as **pushdown** process.
**Pushdown** is a process of pushing processing of particuluar part of the query down to inner select from cube table.
The following sections provides overview of selecting from cube tables and pushdown. 
Please refer to the reference to see whether specific function, operator or expression is supported within selects from **cube tables**.
