use crate::{
    compile::{
        ...
        rewrite::{
            ...
            CubeScanAliases, CubeScanCanPushdownJoin, CubeScanLimit, CubeScanOffset, DimensionName,
            ...
            MemberReplacerAliasToCube, MemberReplacerAliases, ProjectionAlias, SegmentName,
