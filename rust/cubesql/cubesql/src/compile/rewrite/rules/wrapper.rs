use crate::{
    compile::{
        ...
        rewrite::{
            ...
            wrapped_select_projection_expr_empty_tail, wrapper_pullup_replacer,
            wrapper_pushdown_replacer, AggregateFunctionExprDistinct, AggregateFunctionExprFun,
            AliasExprAlias, ColumnExprColumn, CubeScanAliasToCube, CubeScanUngrouped, LimitFetch,
            LimitSkip, LogicalPlanLanguage, ProjectionAlias, ScalarFunctionExprFun,
            WrappedSelectAlias, WrappedSelectLimit, WrappedSelectOffset, WrappedSelectSelectType,
            WrappedSelectType, WrappedSelectUngrouped, WrapperPullupReplacerAliasToCube,
