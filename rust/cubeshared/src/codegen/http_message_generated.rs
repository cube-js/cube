...
impl<'a> HttpMessage<'a> {
  ...
  pub fn message_id(&self) -> u32 {
    ...
    unsafe { self._tab.get::<u32>(HttpMessage::VT_MESSAGE_ID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn command_type(&self) -> HttpCommand {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<HttpCommand>(HttpMessage::VT_COMMAND_TYPE, Some(HttpCommand::NONE)).unwrap()}
  }
  #[inline]
  pub fn command(&self) -> Option<::flatbuffers::Table<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Table<'a>>>(HttpMessage::VT_COMMAND, None)}
  }
  #[inline]
  pub fn connection_id(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(HttpMessage::VT_CONNECTION_ID, None)}
  }
  #[inline]
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> HttpMessageBuilder<'a, 'b, A> {
  ...
  pub fn add_connection_id(&mut self, connection_id: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(HttpMessage::VT_CONNECTION_ID, connection_id);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> HttpMessageBuilder<'a, 'b, A> {
...
impl<'a> StringValue<'a> {
  ...
  pub fn v(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(StringValue::VT_V, None).unwrap()}
  }
}
...
impl<'a> BinaryValue<'a> {
  ...
  pub fn v(&self) -> ::flatbuffers::Vector<'a, u8> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(BinaryValue::VT_V, None).unwrap()}
  }
}
...
impl ::flatbuffers::Verifiable for BinaryValue<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, u8>>>("v", Self::VT_V, true)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> BinaryValueBuilder<'a, 'b, A> {
  ...
  pub fn add_v(&mut self, v: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(BinaryValue::VT_V, v);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> BinaryValueBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    BinaryValueBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> HttpParameter<'a> {
  ...
  pub fn value_type(&self) -> HttpParameterValue {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<HttpParameterValue>(HttpParameter::VT_VALUE_TYPE, Some(HttpParameterValue::NONE)).unwrap()}
  }
  #[inline]
  pub fn value(&self) -> ::flatbuffers::Table<'a> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Table<'a>>>(HttpParameter::VT_VALUE, None).unwrap()}
  }
  #[inline]
  #[allow(non_snake_case)]
...
impl ::flatbuffers::Verifiable for HttpParameter<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_union::<HttpParameterValue, _>("value_type", Self::VT_VALUE_TYPE, "value", Self::VT_VALUE, true, |key, v, pos| {
        match key {
          HttpParameterValue::Int64Value => v.verify_union_variant::<::flatbuffers::ForwardsUOffset<Int64Value>>("HttpParameterValue::Int64Value", pos),
          HttpParameterValue::BoolValue => v.verify_union_variant::<::flatbuffers::ForwardsUOffset<BoolValue>>("HttpParameterValue::BoolValue", pos),
          HttpParameterValue::StringValue => v.verify_union_variant::<::flatbuffers::ForwardsUOffset<StringValue>>("HttpParameterValue::StringValue", pos),
          HttpParameterValue::BinaryValue => v.verify_union_variant::<::flatbuffers::ForwardsUOffset<BinaryValue>>("HttpParameterValue::BinaryValue", pos),
          HttpParameterValue::Float64Value => v.verify_union_variant::<::flatbuffers::ForwardsUOffset<Float64Value>>("HttpParameterValue::Float64Value", pos),
          HttpParameterValue::NullValue => v.verify_union_variant::<::flatbuffers::ForwardsUOffset<NullValue>>("HttpParameterValue::NullValue", pos),
          _ => Ok(()),
        }
     })?
     .finish();
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> HttpParameterBuilder<'a, 'b, A> {
  ...
  pub fn add_value_type(&mut self, value_type: HttpParameterValue) {
    self.fbb_.push_slot::<HttpParameterValue>(HttpParameter::VT_VALUE_TYPE, value_type, HttpParameterValue::NONE);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<::flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(HttpParameter::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> HttpParameterBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> HttpQuery<'a> {
  ...
  pub fn query(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(HttpQuery::VT_QUERY, None)}
  }
  #[inline]
  pub fn trace_obj(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(HttpQuery::VT_TRACE_OBJ, None)}
  }
  #[inline]
  pub fn inline_tables(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<HttpTable<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<HttpTable>>>>(HttpQuery::VT_INLINE_TABLES, None)}
  }
  #[inline]
  pub fn parameters(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<HttpParameter<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<HttpParameter>>>>(HttpQuery::VT_PARAMETERS, None)}
  }
}
...
impl ::flatbuffers::Verifiable for HttpQuery<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<HttpParameter>>>>("parameters", Self::VT_PARAMETERS, false)?
     .finish();
    Ok(())
  }
}
pub struct HttpQueryArgs<'a> {
    ...
    pub parameters: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<HttpParameter<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> HttpQueryBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_parameters(&mut self, parameters: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<HttpParameter<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(HttpQuery::VT_PARAMETERS, parameters);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> HttpQueryBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    HttpQueryBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> HttpTable<'a> {
  ...
  pub fn name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(HttpTable::VT_NAME, None)}
  }
  #[inline]
  pub fn columns(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(HttpTable::VT_COLUMNS, None)}
  }
  #[inline]
  pub fn types(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(HttpTable::VT_TYPES, None)}
  }
  #[inline]
  pub fn csv_rows(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(HttpTable::VT_CSV_ROWS, None)}
  }
}
...
impl ::flatbuffers::Verifiable for HttpTable<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("csv_rows", Self::VT_CSV_ROWS, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> HttpTableBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> HttpTableBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    HttpTableBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> HttpError<'a> {
  ...
  pub fn error(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(HttpError::VT_ERROR, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> HttpErrorBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> HttpErrorBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    HttpErrorBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> HttpResultSet<'a> {
  ...
  pub fn columns(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(HttpResultSet::VT_COLUMNS, None)}
  }
  #[inline]
  pub fn rows(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<HttpRow<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<HttpRow>>>>(HttpResultSet::VT_ROWS, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> HttpResultSetBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> HttpResultSetBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> HttpRow<'a> {
  ...
  pub fn values(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<HttpColumnValue<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<HttpColumnValue>>>>(HttpRow::VT_VALUES, None)}
  }
}
...
impl<'a> HttpColumnValue<'a> {
  ...
  pub fn string_value(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(HttpColumnValue::VT_STRING_VALUE, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> HttpColumnValueBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> HttpColumnValueBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub fn size_prefixed_root_as_http_message(buf: &[u8]) -> Result<HttpMessage<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_http_message_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>, root: ::flatbuffers::WIPOffset<HttpMessage<'a>>) {
