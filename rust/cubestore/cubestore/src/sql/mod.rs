...
pub fn string_prop(credentials: &Vec<SqlOption>, prop_name: &str) -> Option<String> {
    for credential in credentials {
        let SqlOption::KeyValue { key, value } = credential else { continue; };
        ...
        match ast {
            ...
            CubeStoreStatement::CreateTable {
                ...
                let mut import_format = with_options
                    ...
                    .map_or(Result::Ok(ImportFormat::CSV), |(_, value)| {
                        match value {
            ...
            CubeStoreStatement::Statement(Statement::Insert(Insert {
                ...
                let TableObject::TableName(table_name) = table else {
                    return Err(CubeError::user(format!("Insert target is required to be a table name, instead of {}", table)));
                };
...
mod tests {
    ...
    async fn int96_read() {
        ...
        Config::test("int96_read")
            ...
            .start_migration_test(async move |services| {
