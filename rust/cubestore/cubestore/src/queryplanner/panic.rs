...
use datafusion::logical_expr::{Expr, Extension, InvariantLevel, LogicalPlan, UserDefinedLogicalNode};
...
impl UserDefinedLogicalNode for PanicWorkerNode {
    ...
    fn check_invariants(&self, _check: InvariantLevel, _plan: &LogicalPlan) -> Result<(), DataFusionError> {
        Ok(())
    }
