...
impl PartialOrd for ClusterAggregateTopKLower {
    fn partial_cmp(&self, other: &Self) -> Option<Ordering> {
        ...
        let ClusterAggregateTopKLower {
            input, group_expr, aggregate_expr, schema: _, snapshots
        } = self;
...
impl UserDefinedLogicalNode for ClusterAggregateTopKUpper {
    ...
    fn check_invariants(&self, _check: datafusion::logical_expr::InvariantLevel, _plan: &LogicalPlan) -> datafusion::error::Result<()> {
...
impl UserDefinedLogicalNode for ClusterAggregateTopKLower {
    ...
    fn check_invariants(&self, check: datafusion::logical_expr::InvariantLevel, plan: &LogicalPlan) -> datafusion::error::Result<()> {
