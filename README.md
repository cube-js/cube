...
|[Open Source Web Analytics Platform](https://web-analytics-demo.cubecloudapp.dev/)|[web-analytics](./examples/web-analytics)|Building Google Analytics alternative with Snowplow, Athena, Material UI, using pre-aggregations. [[tutorial]](https://web-analytics.cube.dev)|
