...
Provides wiring of all essential Cube components together and can be used as starting point of embedding Cube into wide variety of Node.js web application servers.

[Learn more](https://github.com/cube-js/cube.js#getting-started)

### License

Cube Server Core is [Apache 2.0 licensed](./LICENSE).
