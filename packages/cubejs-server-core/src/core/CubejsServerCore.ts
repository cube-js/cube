...
import { driverDependencies, lookupDriverClass } from './DriverResolver';
...
export class CubejsServerCore extends Configurable {
  ...
  public getOrchestratorApi(context: RequestContext): OrchestratorApi {
    ...
    const orchestratorOptions =
      this.getOrchestratorInitializedOptions(
        context,
