...
export const buildSqlAndParams = async (cubeEvaluator: any, queryParams: any): Promise<boolean> => {
  const native = loadNative();

  return await native.buildSqlAndParams(cubeEvaluator, JSON.stringify(queryParams));
};
