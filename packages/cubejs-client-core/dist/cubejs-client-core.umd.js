(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('core-js/modules/web.dom.iterable'), require('core-js/modules/es6.array.iterator'), require('core-js/modules/es6.regexp.to-string'), require('core-js/modules/es6.date.to-string'), require('core-js/modules/es6.promise'), require('core-js/modules/es6.object.to-string'), require('core-js/modules/es6.object.set-prototype-of'), require('core-js/modules/es6.function.name'), require('core-js/modules/es6.array.for-each'), require('core-js/modules/es6.object.create'), require('core-js/modules/es7.symbol.async-iterator'), require('core-js/modules/es6.symbol'), require('core-js/modules/es6.typed.uint8-array'), require('core-js/modules/es6.function.bind'), require('core-js/modules/es6.number.parse-float'), require('core-js/modules/es6.number.constructor'), require('core-js/modules/es6.number.is-nan'), require('core-js/modules/es6.object.keys'), require('core-js/modules/es6.object.assign'), require('core-js/modules/es6.array.reduce'), require('core-js/modules/es6.regexp.match'), require('core-js/modules/es6.array.index-of'), require('core-js/modules/es6.array.find'), require('core-js/modules/es6.array.filter'), require('core-js/modules/es6.string.iterator'), require('core-js/modules/es6.array.from'), require('core-js/modules/es6.array.map'), require('core-js/modules/es6.array.is-array'), require('core-js/modules/es6.number.is-integer'), require('core-js/modules/es6.regexp.constructor'), require('core-js/modules/es6.regexp.split'), require('core-js/modules/es6.array.sort'), require('core-js/modules/es6.object.is'), require('core-js/modules/es6.regexp.replace'), require('core-js/modules/es6.date.to-iso-string'), require('core-js/modules/es6.set'), require('core-js/modules/es6.array.last-index-of'), require('core-js/modules/es6.string.trim'), require('core-js/modules/es6.date.to-json'), require('core-js/modules/es6.date.now'), require('core-js/modules/es6.object.is-frozen'), require('core-js/modules/es6.array.some'), require('core-js/modules/es6.regexp.search'), require('core-js/modules/es6.object.define-properties'), require('core-js/modules/es6.object.define-property'), require('core-js/modules/es6.typed.data-view')) :
  typeof define === 'function' && define.amd ? define(['core-js/modules/web.dom.iterable', 'core-js/modules/es6.array.iterator', 'core-js/modules/es6.regexp.to-string', 'core-js/modules/es6.date.to-string', 'core-js/modules/es6.promise', 'core-js/modules/es6.object.to-string', 'core-js/modules/es6.object.set-prototype-of', 'core-js/modules/es6.function.name', 'core-js/modules/es6.array.for-each', 'core-js/modules/es6.object.create', 'core-js/modules/es7.symbol.async-iterator', 'core-js/modules/es6.symbol', 'core-js/modules/es6.typed.uint8-array', 'core-js/modules/es6.function.bind', 'core-js/modules/es6.number.parse-float', 'core-js/modules/es6.number.constructor', 'core-js/modules/es6.number.is-nan', 'core-js/modules/es6.object.keys', 'core-js/modules/es6.object.assign', 'core-js/modules/es6.array.reduce', 'core-js/modules/es6.regexp.match', 'core-js/modules/es6.array.index-of', 'core-js/modules/es6.array.find', 'core-js/modules/es6.array.filter', 'core-js/modules/es6.string.iterator', 'core-js/modules/es6.array.from', 'core-js/modules/es6.array.map', 'core-js/modules/es6.array.is-array', 'core-js/modules/es6.number.is-integer', 'core-js/modules/es6.regexp.constructor', 'core-js/modules/es6.regexp.split', 'core-js/modules/es6.array.sort', 'core-js/modules/es6.object.is', 'core-js/modules/es6.regexp.replace', 'core-js/modules/es6.date.to-iso-string', 'core-js/modules/es6.set', 'core-js/modules/es6.array.last-index-of', 'core-js/modules/es6.string.trim', 'core-js/modules/es6.date.to-json', 'core-js/modules/es6.date.now', 'core-js/modules/es6.object.is-frozen', 'core-js/modules/es6.array.some', 'core-js/modules/es6.regexp.search', 'core-js/modules/es6.object.define-properties', 'core-js/modules/es6.object.define-property', 'core-js/modules/es6.typed.data-view'], factory) :
