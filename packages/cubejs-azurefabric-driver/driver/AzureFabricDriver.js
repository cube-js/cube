 ...
 * @license Apache-2.0
 * @fileoverview The `AzureFabricDriver` and related types declaration.
 */
...
const GenericTypeToAzureFabric = {
  boolean: 'bit',
  string: 'nvarchar(max)',
  text: 'nvarchar(max)',
  timestamp: 'datetime2',
...
const AzureFabricToGenericType = {
  bit: 'boolean',
...
/**
 * Azure Fabric driver class.
 */
class AzureFabricDriver extends BaseDriver {
  /**
  ...
  fromGenericType(columnType) {
    return GenericTypeToAzureFabric[columnType] || super.fromGenericType(columnType);
  }

  toGenericType(columnType){
    return AzureFabricToGenericType[columnType] || super.toGenericType(columnType);
  }
...
module.exports = AzureFabricDriver;
