    ...
    switch (typeof parameter) {
      case 'object':
      {
        if (Buffer.isBuffer(parameter)) {
          ...
          const httpParameterValueOffset = BinaryValue.endBinaryValue(builder);
      ...
      case 'boolean':
      {
        ...
        const httpParameterValueOffset = BoolValue.endBoolValue(builder);
      ...
      case 'number':
      {
        if (Number.isInteger(parameter)) {
          ...
          const httpParameterValueOffset = Int64Value.endInt64Value(builder);
          ...
          const httpParameterValueOffset = Float64Value.endFloat64Value(builder);
      ...
      case 'string':
      {
        ...
        const httpParameterValueOffset = StringValue.endStringValue(builder);
