 ...
 * Used by MSSQL's AT TIME ZONE which requires Windows timezone names.
 * Source: CLDR windowsZones.xml (https://github.com/unicode-org/cldr/blob/main/common/supplemental/windowsZones.xml)
 */
