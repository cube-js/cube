/**
 * @title @cubejs-client/dx
 * @permalink /@cubejs-client-dx
 * @menuCategory Cube.js Frontend
 * @subcategory Reference
 * @menuOrder 2
 * @description Type-enhanced JavaScript Cube.js client
 */
...
declare module '@cubejs-client/core' {
  ...
  export type TQueryOrderObject = { [key in IntrospectedMemberName]?: QueryOrder };
  export type TQueryOrderArray = Array<[IntrospectedMemberName, QueryOrder]>;
