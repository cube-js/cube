...
COPY packages/cubejs-duckdb-server-driver/package.json packages/cubejs-duckdb-server-driver/package.json
...
COPY packages/cubejs-duckdb-server-driver/ packages/cubejs-duckdb-server-driver/
