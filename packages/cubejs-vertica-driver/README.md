...
Cube Vertica driver that uses [vertica-nodejs](https://github.com/vertica/vertica-nodejs) package.
...
Cube Vertica Database Driver is [Apache 2.0 licensed](./LICENSE).
