...
export type CrateDriverConfiguration = Partial<PoolConfig> & {
  storeTimezone?: string,
  executionTimeout?: number,
  readOnly?: boolean,
};

export class CrateDriver<Config extends CrateDriverConfiguration = CrateDriverConfiguration>
   ...
   */
  protected getInitialConfiguration(): Partial<CrateDriverConfiguration> {
    return {
      readOnly: true,
    };
  }
