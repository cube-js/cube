  ...
  const dataSource = [
    {
      ...
      url: restUrl,
      docsUrl: 'https://docs.cube.dev/reference/core-data-apis/rest-api',
    },
    {
      key: '2',
      name: 'Websockets Endpoint',
      url: wsUrl,
      docsUrl: 'https://docs.cube.dev/recipes/core-data-api/real-time-data-fetch',
    },
    {
      key: '2',
      name: 'GraphQL Endpoint',
      url: graphqlUrl,
      docsUrl: 'https://docs.cube.dev/reference/core-data-apis/graphql-api',
    },
  ];
        ...
        <Row gutter={48}>
          <Col span={12}>
            <Paragraph>
              ...
              <Link href="https://docs.cube.dev/reference/core-data-apis/rest-api" target="_blank">
                REST
              </Link>
              ,{' '}
              <Link href="https://docs.cube.dev/reference/core-data-apis/graphql-api" target="_blank">
                GraphQL
              </Link>{' '}
              APIs and{' '}
              <Link
                href="https://docs.cube.dev/reference/javascript-sdk"
                target="_blank"
              >
...
const { resultSet, isLoading, error, progress } = useCubeQuery({ 
  ...
  options: { apiUrl: '${apiUrl}/v1' } 
                  ...
                  <Paragraph>
                    ...
                    <Link
                      href="https://docs.cube.dev/reference/javascript-sdk/angular"
                      target="_blank"
                    >
