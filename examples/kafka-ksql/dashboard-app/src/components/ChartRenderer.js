...
const TypeToChartComponent = {
  line: ({ resultSet }) => {
    const data = {
      labels: resultSet.chartPivot().map(c => moment(c.x).format("mm:ss")),
...
const renderChart = Component => ({ resultSet, error, isLoading }) => {
  return (resultSet && <Component resultSet={resultSet} />) ||
