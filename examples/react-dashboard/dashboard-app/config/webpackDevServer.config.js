...
module.exports = function(proxy, allowedHost) {
  return {
    ...
    // Moved to 'static' in version 4
    // contentBase: paths.appPublic,
    // By default files from `contentBase` will not trigger a page reload.
    // Moved to 'static' and renamed to 'watch' in version 4
    ...
    // Moved to 'static' in version 4. 
    // More info: https://github.com/webpack/webpack-dev-server/blob/master/migration-v4.md
    // publicPath: '/',
    static: {
      // contentBase: paths.appPublic,
