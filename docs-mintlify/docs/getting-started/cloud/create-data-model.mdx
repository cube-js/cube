...
description: Cube follows a dataset-oriented data modeling approach, which is inspired by and expands upon dimensional modeling. Cube incorporates this approach and...
---
...
<Frame caption="Architecture diagram of queries being sent to cubes and views">
  <img src="https://ucarecdn.com/bfc3e04a-b690-40bc-a6f8-14a9175fb4fd/" alt="Architecture diagram of queries being sent to cubes and views" />
</Frame>
...
navigate to the **[Visual Modeler][ref-visual-model]** page.
...
[filter parameter](/docs/data-modeling/reference/measures#filters) of the
