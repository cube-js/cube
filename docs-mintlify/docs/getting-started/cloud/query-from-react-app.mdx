...
description: Cube offers both REST and GraphQL APIs, which can be used to query data...
---

# Query from a React app

Cube offers both [REST](/api-reference/rest-api) and
[GraphQL](/api-reference/graphql-api) APIs, which can be used to
