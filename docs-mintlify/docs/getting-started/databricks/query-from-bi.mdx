...
description: You can query Cube using a BI or visualization tool through the Cube SQL API. To provide a good end-user experience in your BI tool, we recommend mapping...
---
...
[public](/docs/data-modeling/reference/cube#public) parameter to `false`.
