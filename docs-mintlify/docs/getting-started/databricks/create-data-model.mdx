...
description: Build and navigate cubes and views in Cube Cloud when Databricks is your warehouse, using the visual modeler and development mode.
---
...
**[Visual Modeler][ref-visual-model]** page.
