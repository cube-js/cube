...
description: "This guide walks you through setting up Cube Cloud, importing a [Bitbucket][bitbucket] repository with an existing Cube project via SSH, and connecting to..."
---
...
[link-connecting-to-databases]: /docs/configuration/data-sources