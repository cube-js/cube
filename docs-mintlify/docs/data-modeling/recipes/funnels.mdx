...
description: "This functionality only works with data models written in JavaScript, not YAML. For more information, check out the [Data Modeling..."
---
...
[ref-partitioned-rollups]: /docs/caching/using-pre-aggregations#time-partitioning
[ref-schema-ref-preaggs-origsql]: /docs/data-modeling/reference/pre-aggregations#original_sql