...
description: Cube is a dataset-centric semantic layer, where all primary objects (cubes and views) are table-like datasets. When designing how your semantic layer will...
---
