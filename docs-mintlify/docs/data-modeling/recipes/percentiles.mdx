...
description: We want to understand the distribution of values for a certain numeric property within a dataset. We're used to average values and intuitively understand...
---
...
[`avg` type](/docs/data-modeling/reference/types-and-formats#avg).
