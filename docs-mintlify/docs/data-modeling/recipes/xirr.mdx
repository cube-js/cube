...
[ref-sql-api]: /api-reference/sql-api/reference#custom-functions
[ref-dax-api]: /api-reference/dax-api/reference#financial-functions
[ref-rest-api]: /api-reference/rest-api
[ref-query-wpp]: /api-reference/queries#query-with-post-processing
[ref-query-regular]: /api-reference/queries#regular-query
