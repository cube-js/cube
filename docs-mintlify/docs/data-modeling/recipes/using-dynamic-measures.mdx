---
title: Generating the data model dynamically
description: Let's assume that we want to understand the distribution of orders by their statuses. Let's imagine that new order statuses can be added in the future, or...
---
