...
description: For a dataset that contains a sequence of changes to a property over time, we want to be able to get the most recent state of said property at any given...
---
...
[extend](/docs/data-modeling/reference/cube#extends) the original `statuses`
...
[`sql()` property](/docs/data-modeling/reference/cube#sql).
