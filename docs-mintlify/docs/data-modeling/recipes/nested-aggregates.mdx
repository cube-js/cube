...
description: Sometimes, there's a need to calculate a double aggregation over a fact table. For example, if you have a line_items table that has store_id,...
---
...
[ref-cube]: /docs/data-modeling/reference/cube
