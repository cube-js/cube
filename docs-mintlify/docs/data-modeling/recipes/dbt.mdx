---
title: Using Cube with dbt
description: "[dbt][link-dbt-docs] is a popular data integration tool used by many Cube users to transform the data in the data warehouse before bringing it to the..."
---
...
<Frame>
  <img src="https://ucarecdn.com/f8613c74-a1df-449d-94a3-ad1026468e05/" />
</Frame>
...
[ref-ref-dimensions]: /docs/data-modeling/reference/dimensions
[ref-ref-measures]: /docs/data-modeling/reference/measures
[ref-ref-joins]: /docs/data-modeling/reference/joins
[ref-ref-pre-aggs]: /docs/data-modeling/reference/pre-aggregations
[ref-ref-views]: /docs/data-modeling/reference/view
[ref-apis]: /api-reference
[ref-time-type]: /docs/data-modeling/reference/types-and-formats#time
[ref-refresh-keys]: /docs/data-modeling/reference/cube#refresh_key
[ref-pre-aggs]: /docs/caching/using-pre-aggregations
[ref-pre-aggs-refresh-keys]: /docs/caching/using-pre-aggregations#refresh-strategy
[ref-orchestration-api]: /api-reference/orchestration-api
[ref-cube-dbt]: /docs/data-modeling/reference/cube_dbt
[ref-cube-dbt-as-cube]: /docs/data-modeling/reference/cube_dbt#modelas_cube
[ref-cube-dbt-as-dimensions]: /docs/data-modeling/reference/cube_dbt#modelas_dimensions
[ref-cube-dbt-data-type]: /docs/data-modeling/reference/cube_dbt#columntype
[ref-template-context]: /docs/data-modeling/reference/cube-package#templatecontext-class
[ref-primary-key]: /docs/data-modeling/reference/dimensions#primary_key
...
[ref-rest-api-meta]: /api-reference/rest-api/reference#base_pathv1meta
