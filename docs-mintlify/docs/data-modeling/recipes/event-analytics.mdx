...
description: This tutorial walks through how to transform raw event data into sessions. Many “out-of-box” web analytics solutions come already prepackaged with sessions,...
---
...
[declare a join](/docs/data-modeling/reference/joins) such that the `events`
