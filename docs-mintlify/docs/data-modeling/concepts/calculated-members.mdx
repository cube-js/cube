...
description: Often, dimensions are mapped to table columns and measures are defined as aggregations of top of table columns. However, measures and dimensions can also...
---
...
[ref-ref-subquery]: /docs/data-modeling/reference/dimensions#sub_query
...
[ref-time-dimension]: /docs/data-modeling/reference/types-and-formats#time
[ref-default-granularities]: /docs/data-modeling/concepts#time-dimensions
[ref-custom-granularities]: /docs/data-modeling/reference/dimensions#granularities