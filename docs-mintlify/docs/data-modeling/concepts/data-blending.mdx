---
title: Data blending
description: When time is the only practical link between cubes, explains the union-style blending pattern to combine metrics without a traditional multi-cube join.
---
