---
title: Extension
description: "The extends parameter, supported for [cubes][ref-cube-extends] and [views][ref-view-extends], allows you to create a _child_ cube (or a view) that reuses..."
---
...
[ref-view-extends]: /docs/data-modeling/reference/view#extends
[ref-schema-ref-cube-filter-params]: /docs/data-modeling/reference/cube#filter-params
