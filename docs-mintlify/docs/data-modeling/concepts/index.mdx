...
| --- | --- |
| `timestamp`, `date`, `time` | [`time`](/docs/data-modeling/reference/types-and-formats#time) |
| `text`, `varchar` | [`string`](/docs/data-modeling/reference/types-and-formats#string) |
| `integer`, `bigint`, `decimal` | [`number`](/docs/data-modeling/reference/types-and-formats#number) |
| `boolean` | [`boolean`](/docs/data-modeling/reference/types-and-formats#boolean) |
...
| --- | --- |
| `AVG` | [`avg`](/docs/data-modeling/reference/types-and-formats#avg) |
| `BOOL_AND`, `BOOL_OR` | [`boolean`](/docs/data-modeling/reference/types-and-formats#boolean) |
| `COUNT` | [`count`](/docs/data-modeling/reference/types-and-formats#count) |
| `COUNT(DISTINCT …)` | [`count_distinct`](/docs/data-modeling/reference/types-and-formats#count_distinct) |
| `APPROX_COUNT_DISTINCT` | [`count_distinct_approx`](/docs/data-modeling/reference/types-and-formats#count_distinct_approx) |
| `MAX` | [`max`](/docs/data-modeling/reference/types-and-formats#max) |
| `MIN` | [`min`](/docs/data-modeling/reference/types-and-formats#min) |
| `PERCENTILE_CONT`, `MEDIAN` | [`number`](/docs/data-modeling/reference/types-and-formats#number) |
| `STRING_AGG`, `LISTAGG` | [`string`](/docs/data-modeling/reference/types-and-formats#string) |
| `SUM` | [`sum`](/docs/data-modeling/reference/types-and-formats#sum) |
| Any function returning a timestamp, e.g., `MAX(time)` | [`time`](/docs/data-modeling/reference/types-and-formats#time) |
...
[`count`](/docs/data-modeling/reference/types-and-formats#count),
[`count_distinct_approx`](/docs/data-modeling/reference/types-and-formats#count_distinct_approx),
[`min`](/docs/data-modeling/reference/types-and-formats#min),
[`max`](/docs/data-modeling/reference/types-and-formats#max),
[`sum`](/docs/data-modeling/reference/types-and-formats#sum).
...
[ref-backend-query-filters]: /api-reference/rest-api/query-format#filters-format
...
[ref-ref-dimension-types]: /docs/data-modeling/reference/types-and-formats#dimension-types
[ref-ref-measure-types]: /docs/data-modeling/reference/types-and-formats#measure-types
[ref-schema-ref-sql]: /docs/data-modeling/reference/cube#sql
[ref-schema-ref-sql-table]: /docs/data-modeling/reference/cube#sql_table
[ref-tutorial-incremental-preagg]: /docs/data-modeling/reference/pre-aggregations#incremental
[ref-cubes]: /docs/data-modeling/reference/cube
[ref-views]: /docs/data-modeling/reference/view
[ref-dimensions]: /docs/data-modeling/reference/dimensions
[ref-measures]: /docs/data-modeling/reference/measures
[ref-joins]: /docs/data-modeling/reference/joins
[ref-segments]: /docs/data-modeling/reference/segments
[ref-preaggs]: /docs/data-modeling/reference/pre-aggregations
...
[ref-ref-time-dimensions]: /docs/data-modeling/reference/types-and-formats#time
[ref-ref-dimension-granularities]: /docs/data-modeling/reference/dimensions#granularities
[ref-ref-primary-key]: /docs/data-modeling/reference/dimensions#primary_key
...
[ref-ref-hierarchies]: /docs/data-modeling/reference/hierarchies
[ref-ref-folders]: /docs/data-modeling/reference/view#folders
...
[ref-apis-support]: /api-reference#data-modeling
[ref-viz-tools]: /docs/configuration/visualization-tools
[ref-data-sources]: /docs/configuration/data-sources
