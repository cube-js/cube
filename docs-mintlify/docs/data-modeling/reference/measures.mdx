---
title: Measures
description: "You can use the measures parameter within [cubes][ref-ref-cubes] to define measures. Each measure is an aggregation over a certain column in your database..."
---
...
Tesseract is currently in preview. Use the [`CUBEJS_TESSERACT_SQL_PLANNER`](/docs/configuration/reference/environment-variables#cubejs_tesseract_sql_planner)
...
[ref-schema-ref-types-formats-measures-types]: /docs/data-modeling/reference/types-and-formats#measure-types
[ref-schema-ref-types-formats-measures-formats]: /docs/data-modeling/reference/types-and-formats#measure-formats
