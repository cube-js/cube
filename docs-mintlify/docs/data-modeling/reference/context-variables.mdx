...
description: "You can use the following context variables within [cube][ref-ref-cubes] definitions:"
---
...
[queries](/api-reference/rest-api/query-format#query-properties).
...
[ref-config-ext-ctx]: /docs/configuration/reference/config#extendcontext
...
[ref-query-filter]: /api-reference/rest-api/query-format#query-properties
[ref-dynamic-jinja]: /docs/data-modeling/dynamic/jinja
[ref-filter-boolean]: /api-reference/rest-api/query-format#boolean-logical-operators