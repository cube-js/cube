---
title: Hierarchies
description: "You can use the hierarchies parameter within [cubes][ref-ref-cubes] to define hierarchies. You can think about a hierarchy as a means to group..."
---
