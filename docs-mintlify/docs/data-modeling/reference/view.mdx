---
title: Views
description: "Views sit on top of the data graph of [cubes][ref-ref-cubes] and create a facade of your whole data model with which data consumers can interact. They are..."
---
...
You can also set the [`CUBEJS_NESTED_FOLDERS_DELIMITER`](/docs/configuration/reference/environment-variables#cubejs_nested_folders_delimiter) environment variable to preserve
...
[ref-dim-name]: /docs/data-modeling/reference/dimensions#name
[ref-dim-title]: /docs/data-modeling/reference/dimensions#title
[ref-dim-description]: /docs/data-modeling/reference/dimensions#description
[ref-dim-format]: /docs/data-modeling/reference/dimensions#format
[ref-dim-meta]: /docs/data-modeling/reference/dimensions#meta