---
title: "`cube` package"
description: "cube package contains tools for setting [configuration options][ref-config-options] and providing the Jinja template context for the data model in..."
---
...
[ref-ref-config-options]: /docs/configuration/reference/config
