---
title: Segments
description: "You can use the segments parameter within [cubes][ref-ref-cubes] to define segments. Segments are predefined filters. You can use segments to define..."
---
...
[ref-backend-query]: /api-reference/rest-api/query-format
