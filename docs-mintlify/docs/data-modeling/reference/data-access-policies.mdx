...
description: "You can use the access_policy parameter within [cubes][ref-ref-cubes] and [views][ref-ref-views] to configure [access policies][ref-dap] for them."
---
...
[ref-mask-dim]: /docs/data-modeling/reference/dimensions#mask
[ref-rest-query-filters]: /api-reference/rest-api/query-format#filters-format
[ref-rest-query-ops]: /api-reference/rest-api/query-format#filters-operators
[ref-rest-boolean-ops]: /api-reference/rest-api/query-format#boolean-logical-operators