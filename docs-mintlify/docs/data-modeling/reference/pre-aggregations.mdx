...
description: "You can use the pre_aggregations parameter within [cubes][ref-ref-cubes] to define [pre-aggregations][ref-pre-aggs]."
---
...
by default via the [[`CUBEJS_PRE_AGGREGATIONS_ALLOW_NON_STRICT_DATE_RANGE_MATCH`](/docs/configuration/reference/environment-variables#cubejs_pre_aggregations_allow_non_strict_date_range_match)][ref-env-allow-non-strict]
...
[ref-config-downstream-superset]: /docs/configuration/visualization-tools/superset
[ref-cube-refreshkey]: /docs/data-modeling/reference/cube#refresh_key
...
[ref-schema-ref-cube-datasource]: /docs/data-modeling/reference/cube#data_source
[ref-schema-dimensions]: /docs/data-modeling/reference/dimensions
[ref-schema-measures]: /docs/data-modeling/reference/measures
[ref-schema-segments]: /docs/data-modeling/reference/segments
[ref-schema-types-dim-time]: /docs/data-modeling/reference/types-and-formats#time
...
[ref-aggregating-indexes]: /docs/caching/using-pre-aggregations#aggregating-indexes
[ref-pre-aggs]: /docs/caching/using-pre-aggregations
[ref-ref-cubes]: /docs/data-modeling/reference/cube
[ref-custom-granularity]: /docs/data-modeling/reference/dimensions#granularities
[ref-env-allow-non-strict]: /docs/configuration/reference/environment-variables#cubejs-pre-aggregations-allow-non-strict-date-range-match
[ref-config-downstream-tableau]: /docs/configuration/visualization-tools/tableau