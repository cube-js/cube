---
title: Joins
description: "You can use the joins parameter within [cubes][ref-ref-cubes] to define joins to other cubes. Joins allow to access and compare members from two or more..."
---
...
[ref-restapi-query-filter-op-set]: /api-reference/rest-api/query-format#set
[ref-schema-fundamentals-join-dir]: /docs/data-modeling/concepts/working-with-joins#direction-of-joins
[ref-schema-cube-sql]: /docs/data-modeling/reference/cube#sql
