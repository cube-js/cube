...
description: "cube_dbt package simplifies defining the data model in the semantic layer on top of [dbt][link-dbt-docs] models. It provides convenient tools for loading..."
---
...
[ref-dimension-sql]: /docs/data-modeling/reference/dimensions#sql
[ref-dimension-type]: /docs/data-modeling/reference/dimensions#type
[ref-dimension-meta]: /docs/data-modeling/reference/dimensions#meta
[ref-dimension-types]: /docs/data-modeling/reference/types-and-formats#dimension-types
