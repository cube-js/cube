...
periods. Such a [calendar-overridden time shift][ref-calendar-cubes-time-shift]
can only be accelerated by a pre-aggregation that stores the shifted measure
itself, not by offsetting a stored column.
...
[ref-calendar-cubes-time-shift]: /docs/data-modeling/concepts/calendar-cubes#overriding-time-shifts
