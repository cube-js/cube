...
description: The data model is used to transform raw data into meaningful business definitions and pre-aggregate data for optimal results. The data model is exposed...
---
...
[ref-backend-restapi]: /api-reference/rest-api/reference
[ref-schema-cube]: /docs/data-modeling/reference/cube
[ref-schema-measures]: /docs/data-modeling/reference/measures
[ref-schema-dimensions]: /docs/data-modeling/reference/dimensions
[ref-schema-types-formats]: /docs/data-modeling/reference/types-and-formats
[ref-backend-query-format]: /api-reference/rest-api/query-format
