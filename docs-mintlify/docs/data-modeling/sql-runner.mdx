---
title: SQL Runner
description: The SQL Runner is a tool that allows you to execute SQL queries from Cube Cloud on your data source or Cube Store. It can be used to inform the development...
---
...
[ref-conf-ref-driverfactory]: /docs/configuration/reference/config#driverfactory
[ref-recipe-multi-src-same-model]: /docs/configuration/recipes/multiple-sources-same-schema
...
[ref-conf-scheduled-refresh-ctx]: /docs/configuration/reference/config#scheduledrefreshcontexts
