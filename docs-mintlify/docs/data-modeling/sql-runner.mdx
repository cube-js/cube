...
SQL Runner account-wide. This only removes the SQL Runner shortcut from the sidebar and
other links to it — running source SQL through Explore or AI tools is unaffected.
