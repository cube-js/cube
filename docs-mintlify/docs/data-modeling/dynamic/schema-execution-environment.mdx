...
description: How JavaScript model code runs inside Cube’s Node VM, including custom require, forbidden globals, and constraints compared to normal Node scripts.
---
