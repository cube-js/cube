...
description: "Cube Data Model Compiler uses [Node.js VM][nodejs-vm] to execute data model compiler code. It gives required flexibility allowing transpiling data model..."
---
...
[ref-schema-path]: /docs/configuration/reference/config#schema_path