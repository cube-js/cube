---
title: Data modeling with JavaScript
...
[link-config-schema-version]: /docs/configuration/reference/config#schema_version
...
[ref-schema-datasource]: /docs/data-modeling/reference/cube#data_source
[ref-config-driverfactory]: /docs/configuration/reference/config#driverfactory
[ref-config]: /docs/configuration/reference/config
