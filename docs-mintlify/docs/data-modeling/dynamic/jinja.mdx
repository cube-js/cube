...
description: "Cube supports authoring dynamic data models using the [Jinja templating language][jinja] and Python. This allows de-duplicating common patterns in your data..."
---
...
[ref-cube-package]: /docs/data-modeling/reference/cube-package
[ref-cube-template-context]: /docs/data-modeling/reference/cube-package#templatecontext-class
[ref-cube-dbt-package]: /docs/data-modeling/reference/cube_dbt
