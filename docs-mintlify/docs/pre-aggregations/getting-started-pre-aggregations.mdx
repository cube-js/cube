...
description: Conceptual introduction to pre-aggregations as Cube Store–backed rollups that tame warehouse latency as analytical data volume grows.
---
...
[ref-caching-preaggs-cubestore]: /docs/pre-aggregations/using-pre-aggregations#pre-aggregations-storage
[ref-caching-preaggs-refresh]: /docs/pre-aggregations/using-pre-aggregations#refresh-strategy
[ref-schema-preaggs]: /reference/data-modeling/pre-aggregations