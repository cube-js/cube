...
You can use the [`CUBEJS_CONCURRENCY`](/docs/configuration/reference/environment-variables#cubejs_concurrency) environment variable to adjust the maximum
...
connections to the database can also be set by using the [`CUBEJS_DB_MAX_POOL`](/docs/configuration/reference/environment-variables#cubejs_db_max_pool)
...
[ref-data-apis]: /api-reference
[ref-data-sources]: /docs/configuration/data-sources
[ref-context-to-orchestrator-id]: /docs/configuration/reference/config#context_to_orchestrator_id
[ref-driver-factory]: /docs/configuration/reference/config#driver_factory
[ref-preagg-refresh]: /docs/caching/refreshing-pre-aggregations#configuration
[ref-athena]: /docs/configuration/data-sources/aws-athena
[ref-clickhouse]: /docs/configuration/data-sources/clickhouse
[ref-databricks]: /docs/configuration/data-sources/databricks-jdbc
[ref-firebolt]: /docs/configuration/data-sources/firebolt
[ref-pinot]: /docs/configuration/data-sources/pinot
[ref-redshift]: /docs/configuration/data-sources/aws-redshift
[ref-snowflake]: /docs/configuration/data-sources/snowflake
[ref-bigquery]: /docs/configuration/data-sources/google-bigquery
