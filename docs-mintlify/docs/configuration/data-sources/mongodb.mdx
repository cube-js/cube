---
title: MongoDB
description: Use MongoDB with Cube through the BI Connector, including prerequisites, warnings about community support and Atlas BI deprecation, and env configuration.
---
