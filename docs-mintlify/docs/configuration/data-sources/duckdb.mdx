---
title: DuckDB
description: Run Cube on DuckDB against local files, S3-compatible object storage, or MotherDuck, including the env vars and access patterns described here.
---
