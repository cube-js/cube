...
description: Set up a Google BigQuery data source in Cube with a service account, required IAM roles for jobs and data access, and project or region settings.
---
