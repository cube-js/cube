...
description: "Cube supports SSL-encrypted connections to various data sources. Please check the documentation for a particular [data source][ref-config-db] for specific..."
---
...
Generally, you can enable SSL via the [`CUBEJS_DB_SSL`](/docs/configuration/reference/environment-variables#cubejs_db_ssl) environment variable.

### Cube Core

To enable SSL, set the [`CUBEJS_DB_SSL`](/docs/configuration/reference/environment-variables#cubejs_db_ssl) environment variable to `true`. Cube can
