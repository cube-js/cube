...
description: Read deployment secrets and tunable settings from environment variables inside cube.py, YAML config, and data model code without committing them to git.
---
