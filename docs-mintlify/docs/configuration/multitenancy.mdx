---
title: Multitenancy
description: Design multi-tenant Cube deployments using security context, app IDs, driver and schema factories, pre-aggregations, and related configuration hooks.
---
...
[ref-config]: /docs/configuration#configuration-options
[ref-config-opts]: /docs/configuration/reference/config
[ref-config-db]: /docs/configuration/data-sources
[ref-config-driverfactory]: /docs/configuration/reference/config#driver_factory
[ref-config-repofactory]: /docs/configuration/reference/config#repository_factory
[ref-config-preagg-schema]: /docs/configuration/reference/config#pre_aggregations_schema
[ref-config-ctx-to-appid]: /docs/configuration/reference/config#context_to_app_id
[ref-config-ctx-to-orch-id]: /docs/configuration/reference/config#context_to_orchestrator_id
[ref-config-multi-data-src]: /docs/configuration/advanced/multiple-data-sources
[ref-config-query-rewrite]: /docs/configuration/reference/config#query_rewrite
[ref-config-refresh-ctx]: /docs/configuration/reference/config#scheduled_refresh_contexts
[ref-config-refresh-tz]: /docs/configuration/reference/config#scheduled_refresh_timezones
[ref-config-security-ctx]: /access-security/access-control/context
[ref-security]: /access-security/access-control
[ref-cube-datasource]: /docs/data-modeling/reference/cube#data_source
[ref-cube-security-ctx]: /docs/data-modeling/reference/context-variables#compile_context
[ref-per-tenant-data-source-recipe]: /docs/configuration/recipes/multiple-sources-same-schema
[ref-per-tenant-data-model-recipe]: /docs/configuration/recipes/custom-data-model-per-tenant