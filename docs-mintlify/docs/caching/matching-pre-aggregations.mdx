...
[ref-schema-joins-rel]: /docs/data-modeling/reference/joins#relationship
...
[ref-non-strict-date-range-match]: /docs/data-modeling/reference/pre-aggregations#allow_non_strict_date_range_match
[ref-non-additive-recipe]: /docs/caching/recipes/non-additivity
[ref-conf-scheduled-refresh-time-zones]: /docs/configuration/reference/config#scheduled_refresh_time_zones
