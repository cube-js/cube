---
description: Understand Cube's two-level caching with in-memory query results and configurable pre-aggregations.
---
...
<Frame>
  <img src="https://ucarecdn.com/cd63c899-3f0d-444d-9476-7d60001ff113/" />
</Frame>


[link-cube-cloud]: https://cube.dev/cloud
[ref-config-preagg-schema]: /docs/configuration/reference/config#preaggregationsschema
[ref-dev-playground]: /docs/workspace/playground
[ref-development-mode]: /docs/configuration#development-mode
...
[ref-schema-ref-cube-refresh-key]: /docs/data-modeling/reference/cube#refresh_key
[ref-schema-ref-preaggs]: /docs/data-modeling/reference/pre-aggregations
[ref-streaming-preaggs]: /docs/caching/lambda-pre-aggregations#batch-and-streaming-data
...
[ref-storage]: /docs/caching/using-pre-aggregations#pre-aggregations-storage