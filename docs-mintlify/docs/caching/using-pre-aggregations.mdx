...
description: Pre-aggregations is an implementation of aggregate awareness in Cube. Pre-aggregation tables are materialized query results. Cube can analyze queries...
---
...
[`CUBEJS_ROLLUP_ONLY`](/docs/configuration/reference/environment-variables#cubejs_rollup_only) environment variable.
...
like [BigQuery](/docs/configuration/data-sources/google-bigquery) or
[AWS Athena](/docs/configuration/data-sources/aws-athena).
...
[ksqlDB](/docs/configuration/data-sources/ksqldb). All pre-aggregations where
...
[ref-schema-ref-preaggs-refresh-key]: /docs/data-modeling/reference/pre-aggregations#refresh_key
[ref-schema-ref-preaggs-refresh-key-every]: /docs/data-modeling/reference/pre-aggregations#every
[ref-schema-ref-preaggs-refresh-key-sql]: /docs/data-modeling/reference/pre-aggregations#sql
...
[ref-original-sql]: /docs/data-modeling/reference/pre-aggregations#original_sql
[self-batching]: #batching
[self-export-bucket]: #export-bucket
[wiki-partitioning]: https://en.wikipedia.org/wiki/Partition_(database)
[ref-ref-indexes]: /docs/data-modeling/reference/pre-aggregations#indexes
[ref-additivity]: /docs/caching/getting-started-pre-aggregations#additivity
[ref-ref-index-type]: /docs/data-modeling/reference/pre-aggregations#type-1
...
[ref-member-sql]: /docs/data-modeling/reference/dimensions#sql
