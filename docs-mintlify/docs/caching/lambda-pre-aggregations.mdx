...
description: Lambda pre-aggregations follow the Lambda architecture design to union real-time and batch data. Cube...
---
...
[streaming-pre-agg]: /docs/caching/using-pre-aggregations#streaming-pre-aggregations