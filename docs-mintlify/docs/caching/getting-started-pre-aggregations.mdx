...
description: Often at the beginning of an analytical application's lifecycle - when there is a smaller dataset that queries execute over - the application works well and...
---
...
[ref-caching-preaggs-cubestore]: /docs/caching/using-pre-aggregations#pre-aggregations-storage
[ref-caching-preaggs-refresh]: /docs/caching/using-pre-aggregations#refresh-strategy
[ref-schema-preaggs]: /docs/data-modeling/reference/pre-aggregations