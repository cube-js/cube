...
description: We want to run queries against pre-aggregations only to ensure our application's superior performance. Usually,...
---
...
[definition](/docs/data-modeling/reference/pre-aggregations#measures).
...
[`count_distinct_approx` type](/docs/data-modeling/reference/types-and-formats#count_distinct_approx)
