...
description: "You can use the [sql parameter][ref-cube-sql] to define [cubes][ref-cubes] over arbitrary SQL queries. Sometimes, these queries might be fairly complex..."
---
...
[ref-schema-ref-preaggs-type-origsql]: /docs/data-modeling/reference/pre-aggregations#original_sql
[ref-schema-ref-preaggs-use-origsql]: /docs/data-modeling/reference/pre-aggregations#use_original_sql_pre_aggregations
