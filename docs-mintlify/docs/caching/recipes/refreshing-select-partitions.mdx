...
description: We have a dataset with orders and we want to aggregate data while having decent performance. Orders have a creation time, so we can use...
---
...
[partitioning](/docs/caching/using-pre-aggregations#partitioning) by time to
...
[`refresh_key`](/docs/data-modeling/reference/pre-aggregations#sql) together
with the [`FITER_PARAMS`](/docs/data-modeling/reference/cube#filter-params)
...
[`partition_granularity` property](/docs/data-modeling/reference/pre-aggregations#partition_granularity).
...
[`refresh_key`](/docs/data-modeling/reference/pre-aggregations#sql) that will
...
[`FILTER_PARAMS`](/docs/data-modeling/reference/cube#filter-params) for that!
