...
[`refresh_key`](/reference/data-modeling/pre-aggregations#sql) together
with the [`FITER_PARAMS`](/reference/data-modeling/cube#filter-params)
...
[`partition_granularity` property](/reference/data-modeling/pre-aggregations#partition_granularity).
...
[`refresh_key`](/reference/data-modeling/pre-aggregations#sql) that will
...
[`FILTER_PARAMS`](/reference/data-modeling/cube#filter-params) for that!
