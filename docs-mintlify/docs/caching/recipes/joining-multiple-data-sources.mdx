...
description: Let's imagine we store information about products and their suppliers in separate databases. We want to aggregate data from these data sources while having...
---
...
[rollup join](/docs/data-modeling/reference/pre-aggregations#rollup_join)
...
First, we'll define
[rollup](/docs/data-modeling/reference/pre-aggregations#rollup)
