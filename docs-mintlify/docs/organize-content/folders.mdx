...
the Excel and Google Sheets chat panes, folder actions run immediately, without the
confirmation step those panes ask for before other destructive actions.
