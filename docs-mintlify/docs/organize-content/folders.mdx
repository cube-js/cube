...
Asking an agent is **wider** in who can do it. That path only checks that you
have **Full access** to the folder itself — it never applies the
content-permission check above. Full access to a folder alone is enough to
scatter its contents to the workspace root, even contents you don't otherwise
have access to.
