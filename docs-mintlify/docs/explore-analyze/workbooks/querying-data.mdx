...
<Frame>
  <img src="https://static.cube.dev/docs/explore-analyze/workbooks/inspect-query-tabs.png" />
</Frame>
...
The **Semantic SQL** tab also has a dropdown for switching between equivalent representations of the same query:

- **Semantic SQL** — the [SQL API][ref-sql-api] format
- **Semantic JSON** — the [REST (JSON) API][ref-rest-api] query format
- **Semantic GraphQL** — the [GraphQL API][ref-graphql-api] query format

The **Semantic JSON** and **Semantic GraphQL** views are convenient when you want to take a query you've built interactively in a workbook and reuse it directly through one of the [Core Data APIs][ref-core-data-apis] from your own application.
...
<Frame>
  <img src="https://static.cube.dev/docs/explore-analyze/workbooks/edit-semantic-sql.png" />
</Frame>
