...
Where a time operator takes a single value, that value is either a fixed date or a relative one, chosen in the filter's own value picker. The **Relative** tab lists presets of two kinds: period values — **Today**, **Yesterday**, **This week**, **This month**, **This quarter**, **This year** — each standing for the whole day, week, month, quarter or year it names, and single moments — **1 week ago**, **1 month ago**, **3 months ago**, **1 year ago**. **Custom** builds any other single moment from a number, a unit and **ago** / **from now**. The operator is the same either way. `between` takes a fixed or relative *range* and offers its own presets, **Past week** through **Past 2 years**.
