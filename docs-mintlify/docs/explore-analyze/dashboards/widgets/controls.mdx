...
- Custom SQL is the one condition no source can be set to: no operator menu offers it, and a filter a hand-written [URL parameter](#sharing-the-current-selection) gives it scopes nothing.
