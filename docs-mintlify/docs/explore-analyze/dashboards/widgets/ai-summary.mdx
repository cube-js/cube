...
In the [dashboard builder][ref-workbooks], add an AI summary from the **Add Other Widgets** menu in the toolbar, where it is listed as **Analysis**. The widget opens with a prompt editor — write your prompt and click **Generate Summary** to produce the first response.
