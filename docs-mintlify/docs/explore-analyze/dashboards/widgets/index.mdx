...
- [Layout](/docs/explore-analyze/dashboards/widgets/layout) — A stack container for grouping widgets, plus a spacer and divider for whitespace and section breaks
