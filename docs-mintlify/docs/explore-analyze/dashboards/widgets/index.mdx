...
Add widgets from the toolbar at the top of the dashboard builder: pick reports from the **Charts** picker to add charts, use the **Add Widgets** menu for text, AI summaries, layout elements, and grid containers, or the **Add Controls** menu for **Filter**, **Time Granularity** and **Parent** controls.
