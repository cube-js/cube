...
In the [dashboard builder][ref-workbooks], open the **Add Other Widgets** menu in the toolbar and choose **Text**. A new text widget is added to the canvas with an empty editor.
