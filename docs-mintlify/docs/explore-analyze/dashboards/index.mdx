...
An admin must turn on comments for your account before this appears; it's a
separate setting from [comments on embedded
dashboards](/embedding/iframe/feature-visibility#account-settings).
