...
An account admin can ask the [Cube support team](/admin/account-billing/support) to hide
Playground account-wide once you've migrated to Explore and Workbooks. This only removes
the Playground shortcut from the sidebar and other links to it — semantic queries remain
available through Explore, Workbooks, and AI tools.
