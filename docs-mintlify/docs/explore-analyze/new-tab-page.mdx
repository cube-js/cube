...
Selecting a workbook lists its reports; choosing a report derives that report's query (and chart)
into your new report without navigating away from the new tab.
...
These are per-deployment Cube Cloud settings — they control the launchpad experience only and do
not change your data model.
