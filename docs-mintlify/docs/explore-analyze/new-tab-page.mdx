---
title: New tab page
description: The launchpad shown when you open Explore or a new workbook tab — search and browse view groups, views, workbooks, certified queries, and source tables to start a report.
---

When you open [Explore](/docs/explore-analyze/explore) or add a new tab in a
[workbook](/docs/explore-analyze/workbooks),
