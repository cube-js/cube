...
| Option | Description |
|---|---|
| **Image height** | Thumbnail height in pixels, 24 by default and up to 96. Sits beside the column's width control. The row grows to fit it and doesn't shift as images load. |
