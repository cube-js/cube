...
| Recommendation | When |
| -- | -- |
| **Map** | The query contains latitude and longitude, or category values that match the regions of a map already in use |
...
| **Pie** | One measure across a few categories, read as parts of a whole |
...
- you have already picked a type by hand in this session.
