...
A pie chart has no X, Y, or Color channel, so its default tooltip covers every member of the query instead, in ring order — any member you have not unchecked.
