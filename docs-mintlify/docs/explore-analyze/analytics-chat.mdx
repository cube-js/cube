...
- **Organize saved work** – Ask the agent to save an exploration into a specific [folder](/docs/organize-content/folders), or to list, create, rename, move, or delete folders in your workspace — folder actions run immediately, and deletion [destroys less than from the Workspace page but checks less too](/docs/organize-content/folders#deleting-folders)
