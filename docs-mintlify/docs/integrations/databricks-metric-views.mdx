...
general regular expression and is limited to 128 characters. Each preview or sync can resolve at
most 128 views for a data source, whether the scope is **all**, **selected**, or **pattern**.
