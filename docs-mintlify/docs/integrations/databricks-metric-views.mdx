...
most 128 views for a data source, whether the scope is **all**, **selected**, or **pattern**. If
**all** or **pattern** resolves more than 128 deployed views, preview and sync reject the request;
...
clients. It does not delete obsolete Metric Views; it currently behaves like `retain`. Choose
`retain` for new settings.
