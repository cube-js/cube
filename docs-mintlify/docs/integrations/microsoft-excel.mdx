...
pane — every add-in conversation on the deployment, not just the current
workbook's — and sync with your Cube account, so they're available from any
device. Like other conversations, they're readable by admins and anyone with
the **Access chat history** permission under
