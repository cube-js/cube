...
request. Unlike deleting a folder from the Workspace page, this only removes
the folder itself: its contents move to the workspace root instead of being
deleted, and a folder that still has sub-folders can't be deleted this way.
