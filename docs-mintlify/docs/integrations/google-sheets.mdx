...
opposite zone, so the same caveats apply: correct for non-additive measures,
...
— and, like other conversations, readable by admins and anyone with the
**Access chat history** permission under
