...
request. Deleting one this way destroys less than [from the Workspace
page][ref-deleting-folders] but checks less too — it skips the content-permission
check that path applies.
