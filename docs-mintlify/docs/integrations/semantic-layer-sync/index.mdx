---
description: Semantic Layer Sync
---
...
[ref-config-file]: /docs/configuration#configuration-options
[ref-config-contexts]: /docs/configuration/reference/config#scheduledrefreshcontexts
[ref-config-schemaversion]: /docs/configuration/reference/config#schema_version
