...
Pulls triggered through the REST API can skip committing entirely: passing
`output: 'files'` returns the generated cube files directly instead of
creating a review branch, so your own CI can review and commit them. The
