...
Then run `/mcp`, select `plugin:cube:cube`, and sign in to Cube. For `cube-admin`,
`cube-embed`, most of `cube-deploy`, and finding saved content, also
[install the Cube CLI](#install-the-cube-cli).
