...
way to reach your data, not a new access surface — with one exception:
[`manageFolders`](#dashboard-authoring) deletes a folder without the
content-permission check the Workspace page applies.
