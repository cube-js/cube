...
way to reach your data, not a new access surface. Workspace-organization actions are a
separate case: `manageFolders`'s delete, for one, [checks less than the equivalent
Workspace-page action][ref-deleting-folders].
