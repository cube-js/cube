...
Letting an AI client edit your semantic model is safe because of five constraints — four
enforced by the MCP server, one by clients that honor tool annotations:
