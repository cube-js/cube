...
inspecting and changing one that already exists. `manageFolders` sits alongside them,
organizing the workspace folders those workbooks and dashboards live in.
