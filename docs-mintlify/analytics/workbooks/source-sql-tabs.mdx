...
description: Source SQL Query tabs allow you to query your connected data sources directly, bypassing the semantic layer. Source SQL Query tabs can be used for...
---
