...
`CUBEJS_DEV_MODE=true`, and only then: it switches off JWT verification on the
REST (JSON) and GraphQL APIs. Playground's endpoints are served with no
authentication too: anyone who
