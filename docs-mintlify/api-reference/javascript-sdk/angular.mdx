...
**Modules.** Inject [`CubeClientModule` and `CubeClient`](/api-reference/javascript-sdk/reference/cubejs-client-ngx#api) into your
components and services to get access to `@cubejs-client/core` API.

**Subjects.** Use [RxJS Subject](/api-reference/javascript-sdk/reference/cubejs-client-ngx#api) and
...
- **Query data from Cube Backend and Transform data for visualization.** Use
  [`CubeClient`](/api-reference/javascript-sdk/reference/cubejs-client-ngx#api) to load data. The
