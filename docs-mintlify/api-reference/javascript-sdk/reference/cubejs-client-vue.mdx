...
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| cubeApi                | [`CubeApi`](/api-reference/javascript-sdk/reference/cubejs-client-core#cubeapi)                                                                                     | `CubeApi` instance to use                                                                                                                                                                                                          |
...
| query?                 | Query                                                                                                                                         | Query parameters ([learn more about the format](/api-reference/rest-api/query-format)). This property is reactive - if you change the object here, the internal query values will be overwritten. This is not two-way. |
...
- `resultSet`: A `resultSet` is an object containing data obtained from the
  query. [`ResultSet`](/api-reference/javascript-sdk/reference/cubejs-client-core#resultset) object
...
| Name       | Type                                                  |
| ---------- | ----------------------------------------------------- |
| query      | [`Query`](/api-reference/javascript-sdk/reference/cubejs-client-core#query-1) |
...
| -------------------------- | ------------------------------------------------------------------ |
| chartType?                 | [ChartType](#types-chart-type)                                     |
| pivotConfig?               | [`PivotConfig`](/api-reference/javascript-sdk/reference/cubejs-client-core#pivotconfig) |
