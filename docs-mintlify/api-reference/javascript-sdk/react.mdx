...
[useCubeQuery hook](/api-reference/javascript-sdk/reference/cubejs-client-react#usecubequery) to
functional React components to execute Cube queries.

**Components.** You can use
[`QueryBuilder`](/api-reference/javascript-sdk/reference/cubejs-client-react#querybuilder) and
[`QueryRenderer`](/api-reference/javascript-sdk/reference/cubejs-client-react#queryrenderer)
components to separate state management and API calls from your rendering code.
You can also use
[`CubeProvider`](/api-reference/javascript-sdk/reference/cubejs-client-react#cubeprovider) and
[`CubeContext`](/api-reference/javascript-sdk/reference/cubejs-client-react#cubecontext) components
...
- **Query data from Cube Backend.** In functional React components, use the
  ...
  See [Query Format](/api-reference/rest-api/query-format) for
  details.
