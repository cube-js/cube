...
description: When building an embedded analytics application, you'd like to provide a real-time experience to the users. On some page, you'd like to display a chart that...
---
...
[ref-websocket-transport]: /api-reference/rest-api#websocket-transport
[ref-refresh-key]: /docs/caching#refresh-keys
[ref-every]: /docs/data-modeling/reference/cube#refresh_key