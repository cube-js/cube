---
title: Drilldowns
description: Drilldowns are a powerful feature to facilitate data exploration. It allows building an interface to let users dive deeper into visualizations and data...
---
...
[ref-cube-client-ref-resultset-drilldown]: /api-reference/javascript-sdk/reference/cubejs-client-core#drilldown
[blog-drilldown-api]: https://cube.dev/blog/introducing-a-drill-down-table-api-in-cubejs/
[ref-schema-ref-measures]: /docs/data-modeling/reference/measures