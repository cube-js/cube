...
description: We have a dashboard with information about the users, and we'd like to filter them by city. To do so, we need to display all unique values for cities in the...
---
...
[dimensions](/docs/data-modeling/reference/dimensions).
...
[`/meta` endpoint](/api-reference/rest-api/reference#base_pathv1meta):
