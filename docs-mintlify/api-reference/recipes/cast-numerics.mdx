...
description: The REST API returns numeric measure and dimension values as strings. However, we'd like to receive them as JavaScript Number type. In the recipe below,...
---
...
[ref-cube-core]: /api-reference/javascript-sdk/reference/cubejs-client-core
[ref-cube-core-cast-numerics]: /api-reference/javascript-sdk/reference/cubejs-client-core#loadmethodoptions