...
hierarchies_ in [Power BI][ref-power-bi]. You can set the [`CUBEJS_DAX_CREATE_DATE_HIERARCHIES`](/docs/configuration/reference/environment-variables#cubejs_dax_create_date_hierarchies)
...
[ref-ref-dax-api]: /api-reference/dax-api/reference
...
[ref-power-bi]: /docs/configuration/visualization-tools/powerbi