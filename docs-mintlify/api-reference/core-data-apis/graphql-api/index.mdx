---
description: "Query Cube over HTTP using GraphQL for embedded analytics and front-end data applications."
---
...
scope, e.g., by setting the [`CUBEJS_DEFAULT_API_SCOPES`](/docs/configuration/reference/environment-variables#cubejs_default_api_scopes) environment variable to
`meta,data`.
...
[ref-schema-ref-preagg-granularity]: /docs/data-modeling/reference/pre-aggregations#granularity
[ref-rest-api]: /api-reference/rest-api
[ref-api-scopes]: /api-reference/rest-api#configuration-api-scopes
[ref-cors]: /api-reference/rest-api#configuration-cors
[graphql]: https://graphql.org
[cube-ea]: https://cube.dev/use-cases/embedded-analytics
[ref-ref-graphql-api]: /api-reference/graphql-api/reference
[ref-websockets]: /api-reference/rest-api/real-time-data-fetch#web-sockets
[ref-subscriptions]: /api-reference/rest-api/real-time-data-fetch#client-subscriptions
[ref-compare-date-range]: /api-reference/queries#compare-date-range-query
[ref-metadata]: /api-reference/rest-api/reference#base_pathv1meta
[ref-pivot-config]: /api-reference/javascript-sdk/reference/cubejs-client-core#pivotconfig
