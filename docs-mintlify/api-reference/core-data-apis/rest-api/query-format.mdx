...
description: Queries to the REST API are plain JavaScript objects, describing an analytics query. The basic elements of a query (query members) are measures,...
---
...
[type of the dimension](/docs/data-modeling/reference/types-and-formats#dimension-types).
...
[ref-client-core-resultset-drilldown]: /api-reference/javascript-sdk/reference/cubejs-client-core#drilldown
[ref-schema-ref-preaggs-refreshkey]: /docs/data-modeling/reference/pre-aggregations#refresh_key
[ref-schema-ref-preaggs-refreshkey-every]: /docs/data-modeling/reference/pre-aggregations#every
[ref-schema-ref-preaggs-dimensions]: /docs/data-modeling/reference/pre-aggregations#dimensions
[ref-schema-ref-preaggs-time-dimension]: /docs/data-modeling/reference/pre-aggregations#time_dimension
...
[ref-total-query]: /api-reference/queries#total-query
[ref-ungrouped-query]: /api-reference/queries#ungrouped-query
[ref-default-order]: /api-reference/queries#order
