...
the [`CUBEJS_WEB_SOCKETS`](/docs/configuration/reference/environment-variables#cubejs_web_sockets) environment variable.
...
[`CUBEJS_DEFAULT_API_SCOPES`](/docs/configuration/reference/environment-variables#cubejs_default_api_scopes) environment variable. For example, to disallow
access to the GraphQL API for everyone, set [`CUBEJS_DEFAULT_API_SCOPES`](/docs/configuration/reference/environment-variables#cubejs_default_api_scopes) to
`meta,data`.
...
[`CUBEJS_DEFAULT_API_SCOPES`](/docs/configuration/reference/environment-variables#cubejs_default_api_scopes) to `data,graphql` and use the following
...
[ref-conf-queue-opts]: /docs/configuration/reference/config#queueoptions
[ref-rest-query-format]: /api-reference/rest-api/query-format#query-properties
[ref-ref-meta-endpoint]: /api-reference/rest-api/reference#base_pathv1meta
[ref-config-cors]: /docs/configuration/reference/config#http
[ref-schema-ref-cube-refresh-key]: /docs/data-modeling/reference/cube#refresh_key
[ref-security]: /access-security/access-control
[ref-notebooks]: /docs/configuration/visualization-tools#notebooks
[ref-observable]: /docs/configuration/visualization-tools/observable
[ref-low-code]: /docs/configuration/visualization-tools#low-code-tools-internal-tool-builders
[ref-retool]: /docs/configuration/visualization-tools/retool
[ref-conf-basepath]: /docs/configuration/reference/config#basepath
[ref-conf-contexttoapiscopes]: /docs/configuration/reference/config#contexttoapiscopes
[ref-ref-load]: /api-reference/rest-api/reference#base_pathv1load
[ref-ref-meta]: /api-reference/rest-api/reference#base_pathv1meta
[ref-ref-sql]: /api-reference/rest-api/reference#base_pathv1sql
[ref-ref-cubesql]: /api-reference/rest-api/reference#base_pathv1cubesql
[ref-ref-paj]: /api-reference/rest-api/reference#base_pathv1pre-aggregationsjobs
...
[ref-ref-rest-api]: /api-reference/rest-api/reference
...
[ref-concurrency]: /docs/configuration/concurrency
[ref-data-warehouses]: /docs/configuration/data-sources#data-warehouses
[ref-traditional-databases]: /docs/configuration/data-sources#transactional-databases
[ref-pre-aggregations]: /docs/caching/using-pre-aggregations
[ref-javascript-sdk]: /api-reference/javascript-sdk
[ref-recipe-real-time-data-fetch]: /api-reference/recipes/real-time-data-fetch
[ref-refresh-keys]: /docs/data-modeling/reference/cube#refresh_key
[link-websocat]: https://github.com/vi/websocat
[ref-ref-metadata]: /api-reference/core-data-apis/rest-api/reference#metadata-api