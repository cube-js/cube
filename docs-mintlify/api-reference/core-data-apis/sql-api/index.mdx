...
<Frame>
  <img src="https://ucarecdn.com/70646e5a-12bd-45a3-84ad-004de11ed536/" />
</Frame>
...
**SQL API is disabled by default.** To enable the SQL API, set [`CUBEJS_PG_SQL_PORT`](/docs/configuration/reference/environment-variables#cubejs_pg_sql_port)
...
| Port       | Set via [`CUBEJS_PG_SQL_PORT`](/docs/configuration/reference/environment-variables#cubejs_pg_sql_port)   |
| User name  | Set via [`CUBEJS_SQL_USER`](/docs/configuration/reference/environment-variables#cubejs_sql_user)      |
| Password   | Set via [`CUBEJS_SQL_PASSWORD`](/docs/configuration/reference/environment-variables#cubejs_sql_password)  |
| Database   | Any valid string, e.g., `cube` |

You can also use
[`checkSqlAuth`][ref-config-checksqlauth],
[`canSwitchSqlUser`][ref-config-canswitchsqluser], and [`CUBEJS_SQL_SUPER_USER`](/docs/configuration/reference/environment-variables#cubejs_sql_super_user)
...
[`CUBEJS_PG_SQL_PORT`](/docs/configuration/reference/environment-variables#cubejs_pg_sql_port), [`CUBEJS_SQL_USER`](/docs/configuration/reference/environment-variables#cubejs_sql_user), and [`CUBEJS_SQL_PASSWORD`](/docs/configuration/reference/environment-variables#cubejs_sql_password) environment
...
You can use the [`CUBEJS_MAX_SESSIONS`](/docs/configuration/reference/environment-variables#cubejs_max_sessions) environment variable to adjust the session
limit.
...
[ref-sql-api-auth]: /api-reference/sql-api/security
[ref-config-checksqlauth]: /docs/configuration/reference/config#checksqlauth
[ref-config-canswitchsqluser]: /docs/configuration/reference/config#canswitchsqluser
[ref-dataviz-tools]: /docs/configuration/visualization-tools
[ref-bi]: /docs/configuration/visualization-tools#bi-data-exploration-tools
[ref-thoughtspot]: /docs/configuration/visualization-tools/thoughtspot
[ref-sigma]: /docs/configuration/visualization-tools/sigma
[ref-looker-studio]: /docs/configuration/visualization-tools/looker-studio
[ref-notebooks]: /docs/configuration/visualization-tools#notebooks
[ref-jupyter]: /docs/configuration/visualization-tools/jupyter
[ref-hex]: /docs/configuration/visualization-tools/hex
[ref-deepnote]: /docs/configuration/visualization-tools/deepnote
[ref-sql-query-format]: /api-reference/sql-api/query-format
...
[ref-ungrouped-queries]: /api-reference/queries#ungrouped-query
...
[ref-queries-row-limit]: /api-reference/queries#row-limit
[ref-rest-api]: /api-reference/rest-api
[ref-rest-api-cubesql]: /api-reference/rest-api/reference#base_pathv1cubesql
[ref-caching]: /docs/caching
[ref-rest-cache-control]: /api-reference/rest-api#cache-control
[ref-set-command]: /api-reference/sql-api/reference#set