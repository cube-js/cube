...
| --- | --- |
| [`avg`](/docs/data-modeling/reference/types-and-formats#avg) | `MEASURE` or `AVG` | 
| [`boolean`](/docs/data-modeling/reference/types-and-formats#boolean) | `MEASURE` |
| [`count`](/docs/data-modeling/reference/types-and-formats#count) | `MEASURE` or `COUNT` |
| [`count_distinct`](/docs/data-modeling/reference/types-and-formats#count_distinct) | `MEASURE` or `COUNT(DISTINCT …)` |
| [`count_distinct_approx`](/docs/data-modeling/reference/types-and-formats#count_distinct_approx) | `MEASURE` or `COUNT(DISTINCT …)` |
| [`max`](/docs/data-modeling/reference/types-and-formats#max) | `MEASURE` or `MAX` |
| [`min`](/docs/data-modeling/reference/types-and-formats#min) | `MEASURE` or `MIN` |
| [`number`](/docs/data-modeling/reference/types-and-formats#number) | `MEASURE` or any other function from this table |
| [`string`](/docs/data-modeling/reference/types-and-formats#string) | `MEASURE` or `STRING_AGG` |
| [`sum`](/docs/data-modeling/reference/types-and-formats#sum) | `MEASURE` or `SUM` |
| [`time`](/docs/data-modeling/reference/types-and-formats#time) | `MEASURE` or `MAX` or `MIN` |
...
Please [refer to this page](/api-reference/sql-api/joins) for details
on joins.
...
[ref-regular-queries]: /api-reference/queries#regular-query
[ref-queries-wpp]: /api-reference/queries#query-with-post-processing
[ref-queries-wpd]: /api-reference/queries#query-with-pushdown
[ref-data-model-concepts]: /docs/data-modeling/concepts
[ref-measure-types]: /docs/data-modeling/reference/types-and-formats#measure-types
[ref-query-default-limit]: /api-reference/queries#row-limit
[ref-ref-sql-api]: /api-reference/sql-api/reference
