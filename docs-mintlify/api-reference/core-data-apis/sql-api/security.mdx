...
description: "Cube can be configured with dynamic username & password verification system by setting a [checkSqlAuth()][ref-config-check-sql-auth] function in the..."
---
...
```twigtitle="model/cubes/users.yml"
...
[ref-config-can-switch-sql-user]: /docs/configuration/reference/config#canswitchsqluser
[ref-config-check-sql-auth]: /docs/configuration/reference/config#checksqlauth
[ref-config-ctx-to-app-id]: /docs/configuration/reference/config#contexttoappid
[ref-config-queryrewrite]: /docs/configuration/reference/config#queryrewrite
