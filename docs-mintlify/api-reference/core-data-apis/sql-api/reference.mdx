...
[ref-qpd]: /api-reference/sql-api/query-format#query-pushdown
[ref-qpp]: /api-reference/sql-api/query-format#query-post-processing
[ref-sql-api]: /api-reference/sql-api
[ref-sql-api-aggregate-functions]: /api-reference/sql-api/query-format#aggregate-functions
...
[ref-sql-cache-control]: /api-reference/sql-api#cache-control