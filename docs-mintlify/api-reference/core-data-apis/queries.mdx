...
description: "After creating a [data model][ref-data-model], you would like to ask questions to it, i.e., run queries against this data model. This page describes the..."
---
...
[`CUBEJS_DB_QUERY_DEFAULT_LIMIT`](/docs/configuration/reference/environment-variables#cubejs_db_query_default_limit) environment variable to override it. This serves
as a safeguard against data scraping and denial-of-service (DoS) attacks if Cube
is exposed to untrusted environments.

The maximum allowed limit is 50,000 rows. You can use the [`CUBEJS_DB_QUERY_LIMIT`](/docs/configuration/reference/environment-variables#cubejs_db_query_limit)
...
[`CUBEJS_DEFAULT_TIMEZONE`](/docs/configuration/reference/environment-variables#cubejs_default_timezone) environment variable to override it.
...
[ref-sql-api-qpp]: /api-reference/sql-api/query-format#query-post-processing
[ref-sql-api-qpd]: /api-reference/sql-api/query-format#query-pushdown
[ref-rest-api]: /api-reference/rest-api
[ref-rest-api-load]: /api-reference/rest-api/reference#v1load
[ref-graphql-api]: /api-reference/graphql-api
[ref-data-sources]: /docs/configuration/data-sources
[ref-rest-api-query-format-options]: /api-reference/rest-api/query-format#query-properties
[ref-rest-api-query-format-options-tdf]: /api-reference/rest-api/query-format#time-dimensions-format
[ref-ref-graphql-api-args]: /api-reference/graphql-api/reference#cubequeryargs
[ref-sql-utils]: /docs/data-modeling/reference/context-variables#sql_utils
...
[ref-pagination-recipe]: /api-reference/recipes/pagination
[ref-primary-key]: /docs/data-modeling/reference/dimensions#primary_key
[ref-conf-allow-ungrouped]: /docs/configuration/reference/config#allow_ungrouped_without_primary_key
