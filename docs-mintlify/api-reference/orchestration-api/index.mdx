...
enable the `jobs` scope, e.g., by setting the [`CUBEJS_DEFAULT_API_SCOPES`](/docs/configuration/reference/environment-variables#cubejs_default_api_scopes)
...
[ref-scheduled-refresh]: /docs/data-modeling/reference/pre-aggregations#scheduled_refresh
...
[ref-lambda-pre-aggs]: /docs/caching/lambda-pre-aggregations
[ref-rest-api]: /api-reference/rest-api
[ref-api-scopes]: /api-reference/rest-api#configuration-api-scopes
[ref-ref-jobs-endpoint]: /api-reference/rest-api/reference#base_pathv1pre-aggregationsjobs
