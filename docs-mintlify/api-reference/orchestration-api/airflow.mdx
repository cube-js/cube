...
description: "[Apache Airflow][airflow] is a popular open-source workflow scheduler commonly used for data orchestration. [Astro][astro] is a fully managed service for..."
---
...
- `conn_password` should be set to the value of the [`CUBEJS_API_SECRET`](/docs/configuration/reference/environment-variables#cubejs_api_secret)
