...
In the command above, we're specifying [`CUBEJS_CUBESTORE_HOST`](/docs/configuration/reference/environment-variables#cubejs_cubestore_host) to let Cube know
...
Also requires the M [Cube Store Worker tier](/admin/pricing#cube-store-worker-tiers).
...
runs against your data source via the [`CUBEJS_DB_QUERY_TIMEOUT`](/docs/configuration/reference/environment-variables#cubejs_db_query_timeout) environment variable.
...
[ref-config-env]: /docs/configuration/reference/environment-variables
...
[ref-pre-agg-incremental]: /docs/data-modeling/reference/pre-aggregations#incremental
[ref-pre-agg-build-range]: /docs/data-modeling/reference/pre-aggregations#build_range_start-and-build_range_end
[ref-cube-sql]: /docs/data-modeling/reference/cube#sql
[ref-pre-agg-original-sql]: /docs/data-modeling/reference/pre-aggregations#original_sql
[ref-pre-agg-use-original-sql]: /docs/data-modeling/reference/pre-aggregations#use_original_sql_pre_aggregations