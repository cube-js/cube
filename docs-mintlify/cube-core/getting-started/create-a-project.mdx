...
Note that we're setting the [`CUBEJS_DEV_MODE`](/docs/configuration/reference/environment-variables#cubejs_dev_mode) environment variable to `true` to
enable the [Development Mode](/docs/configuration#development-mode). This is
