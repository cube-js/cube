---
description: Learn about Cube Core's production deployment architecture, including API instances, refresh workers, and Cube Store.
title: Architecture
---
...
via STS and refreshes credentials automatically before they expire or when the
token file changes.
