...
description: "Some visualization tools (e.g., custom front-end applications) can pass access tokens based on the [JSON Web Token][wiki-jwt] (JWT) standard to Cube. These..."
---
