...
description: How to configure Cube to validate JWTs from custom apps or identity providers, including keys, audiences, issuers, and optional custom check_auth logic.
---
