...
- Go to **Admin → API Keys** in your Cube admin panel
...
To point the embed at a staging or development branch instead of production, pass that branch's name as `branchName` — see [Branch selection][ref-branch-selection].
...
[ref-branch-selection]: /reference/embed-apis/generate-session#branch-selection
