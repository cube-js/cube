...
These parameters accept either `1` or `true`, and hide chrome only. Whether the
session may use AI at all is decided when you generate it (`settings.allowAi`) —
see [Show and hide features](/embedding/iframe/feature-visibility).
