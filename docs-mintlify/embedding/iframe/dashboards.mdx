...
Viewers of an embedded dashboard can discuss it in comment threads, once the
account turns on **Allow comments on embedded dashboards** under **Embed →
Settings**. [Dashboard Comments](/reference/embed-apis/dashboard-comments)
documents the setting, the API behind it, and who may edit, delete, and resolve.
