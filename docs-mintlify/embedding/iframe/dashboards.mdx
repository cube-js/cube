...
Viewers of an embedded dashboard can discuss it in comment threads, privately
within their own embed tenant. The comment panel appears once the account turns
