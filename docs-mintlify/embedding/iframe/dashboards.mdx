...
Viewers of an embedded dashboard can discuss it in comment threads. The comment
panel appears once the account turns on **Allow comments on embedded dashboards**
under **Embed → Settings**, which is off by default.
