...
`allowExport` is the single switch that grants all of these — there is no way
to allow one format while blocking another. It also grants **Download as CSV**
in the Creator Mode report builder; see [Show and hide
