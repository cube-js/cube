...
| **Allow comments on embedded dashboards** | The comment panel on embedded published dashboards. Separate from commenting in the Cube app, which has its own setting. See [Dashboard Comments](/reference/embed-apis/dashboard-comments). | Off |
