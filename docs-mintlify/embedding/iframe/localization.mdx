...
<Note>
  This page covers embedded surfaces only. To set the language of the main Cube Cloud
  console for your own user, see [user preferences](/admin/users-and-permissions/manage-users#language).
</Note>
