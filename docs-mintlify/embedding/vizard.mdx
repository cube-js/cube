...
description: "Chart Prototyping generates code of a front-end application that works with the [REST API][ref-rest-api] and visualizes data on charts. It's convenient for..."
---
