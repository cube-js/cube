...
You can also export audit log events programmatically using the
[Control Plane API][ref-control-plane-api]. This is useful for integrating
with external log aggregation or SIEM tools.

See the [`/api/v1/audit-log/events`][ref-audit-log-api] endpoint for details.
...
[ref-audit-log-api]: /reference/control-plane-api#apiv1audit-logevents
