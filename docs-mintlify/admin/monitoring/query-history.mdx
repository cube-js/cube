...
You can also choose a [Query History tier](/admin/pricing#query-history-tiers).
...
[ref-conf-db]: /docs/configuration/data-sources
[ref-workspace-sqlrunner]: /docs/data-modeling/sql-runner
[ref-query-format]: /api-reference/rest-api/query-format
