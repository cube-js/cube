...
If you embed Cube for multiple customers, group Dashboard Usage, Authoring, and
Inventory by `viewer_embed_tenant` (on Dashboard Usage) to see which of your embed
