...
[Azure Blob Storage](https://azure.microsoft.com/en-us/products/storage/blobs) can be used as storage for [export buckets](/docs/pre-aggregations/using-pre-aggregations#export-bucket) and [pre-aggregations](/docs/pre-aggregations/using-pre-aggregations).
...
[Azure Monitor](https://azure.microsoft.com/en-us/products/monitor) and [Azure Blob Storage](https://azure.microsoft.com/en-us/products/storage/blobs) can be used as destinations for [monitoring integrations](/admin/deployment/monitoring-integrations).
