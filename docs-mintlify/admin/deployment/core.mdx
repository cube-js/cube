...
[link-cubejs-dev-vs-prod]: /docs/configuration#development-mode
[link-k8s-healthcheck-api]:
  https://kubernetes.io/docs/reference/using-api/health-checks/
[ref-config-connect-db]: /connecting-to-the-database
[ref-caching-cubestore]: /docs/caching/running-in-production
[ref-conf-preaggs-schema]: /docs/configuration/reference/config#pre_aggregations_schema
[ref-env-vars]: /docs/configuration/reference/environment-variables
...
[ref-api-readyz]: /api-reference/rest-api/reference#readyz
[ref-api-livez]: /api-reference/rest-api/reference#livez
[ref-data-store-cost-saving-guide]: /docs/configuration/recipes/data-store-cost-saving-guide
...
[ref-config-sched-ref-ctx]: /docs/configuration/reference/config#scheduledrefreshcontexts