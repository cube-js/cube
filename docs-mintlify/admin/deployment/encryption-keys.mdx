...
description: "The Encryption Keys page in Cube Cloud allows to manage [data-at-rest encryption in Cube Store][ref-cube-store-encryption]."
---

# Encryption keys

The **Encryption Keys** page in Cube Cloud allows to manage [data-at-rest
...
[ref-pre-aggs-refresh-strategy]: /docs/caching/using-pre-aggregations#refresh-strategy
[ref-pre-aggs-build-manually]: /admin/monitoring/pre-aggregations
[ref-pre-aggs-incremental]: /docs/data-modeling/reference/pre-aggregations#incremental
