...
description: Available on Starter and above plans.
hidden: true
---
...
<Frame caption="Cube Cloud auto-suspend flowchart">
...
<Frame>
  <img src="https://ucarecdn.com/b0a3f38d-6631-47a8-b952-45747cf5255c/" />
</Frame>
...
Users who can resume the deployment are also notified in their notification
inbox when it suspends, with a link straight to it. This excludes anyone
already working on the deployment in dev mode, since their own branch stays
