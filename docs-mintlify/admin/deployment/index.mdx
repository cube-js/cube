---
description: Learn about Cube's production deployment architecture, including API instances, refresh workers, and Cube Store.
---
...
[`CUBEJS_CUBESTORE_PORT`](/docs/configuration/reference/environment-variables#cubejs_cubestore_port) environment variable for Cube API Instances and Refresh
Worker.
...
[ref-caching-inspect-sql]: /docs/caching/using-pre-aggregations#inspecting-pre-aggregations
### Cube Store Worker
...
[ref-deploy-prod-list]: /docs/deployment/production-checklist
[ref-deploy-cubecloud]: /docs/deployment/cloud
[ref-deploy-docker]: /docs/deployment/core
[ref-config-env]: /docs/configuration/reference/environment-variables
[ref-config-js]: /docs/configuration/reference/config
[ref-conf-ref-schemapath]: /docs/configuration/reference/config#schema_path
