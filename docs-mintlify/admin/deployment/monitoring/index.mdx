...
You can also choose a [Monitoring Integrations tier](/admin/pricing#monitoring-integrations-tiers).
...
tier](/admin/pricing#monitoring-integrations-tiers).
...
refresh scheduler, use the [`CUBEJS_LOG_LEVEL`](/docs/configuration/reference/environment-variables#cubejs_log_level) environment variable.
...
Requires the [M tier](/admin/pricing#monitoring-integrations-tiers)
...
[ref-preagg-warmup]: /docs/deployment/cloud/warm-up#pre-aggregation-warm-up
