---
title: Integration with New Relic
description: New Relic is an all-in-one observability platform. This guide demonstrates how to set up Cube Cloud to export logs and metrics to...
---
...
[ref-monitoring-integrations-conf]: /admin/deployment/monitoring#configuration