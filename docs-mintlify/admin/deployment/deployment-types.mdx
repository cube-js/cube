...
shared with other Cube customers.
...
<div style={{ textAlign: "center" }}>
  <img
    alt="High-level architecture diagram of a Shared deployment"
...
Shared deployments run on compute shared with other Cube customers, which
keeps the cost low but means resources aren't reserved for you exclusively.
...
<div style={{ textAlign: "center" }}>
  <img
    alt="High-level architecture diagram of a Dedicated deployment"
...
<Frame>
  <img src="https://ucarecdn.com/fbde6a1e-734a-4091-8edd-922dc1ee7e1c/" alt="Deployment Settings page showing Shared, Dedicated, and Multi-cluster options" />
</Frame>
