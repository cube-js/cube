...
between VPC networks in different projects or organizations, without exposing
your traffic to the public internet. To set up a PSC connection between Cube's
Dedicated Infrastructure and your own VPC, you'll need to publish a Service
Attachment, share its details with the Cube team, and approve the incoming
connection request.
