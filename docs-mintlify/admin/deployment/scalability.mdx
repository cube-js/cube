---
title: Scalability
description: Cube Cloud also allows adding additional infrastructure to your deployment to increase scalability and performance beyond what is available with each...
---
