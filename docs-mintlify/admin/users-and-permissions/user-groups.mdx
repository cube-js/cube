---
title: User groups
description: "User groups allow you to organize users and manage access collectively. Instead of assigning [user attributes][ref-user-attributes] to individual users, you..."
---
