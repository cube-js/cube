...
As a custom role's Base Role, the action sets the license tier — see [Base Role](#base-role) for which of these capabilities that carries.

| Internal name   | Label     | Access the built-in role of that name has                  |
| --------------- | --------- | ---------------------------------------------------------- |
