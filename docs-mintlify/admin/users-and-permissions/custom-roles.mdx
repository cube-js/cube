...
| Monitoring  | Access chat history                 | View other users' chat conversations for the deployment, including Analytics Chat and the Excel/Google Sheets add-in panes (**Admin → Chats History**). It does not [force the Base Role to Developer](#auto-bump-to-developer), so grant it only to roles that should see other people's conversations. |
