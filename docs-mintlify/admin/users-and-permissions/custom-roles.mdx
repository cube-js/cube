...
<Steps>
  ...
  <Step title="Add a deployment policy">
    Click **Add deployment policy**, leave **Scope** on **All deployments**, and check **Access deployment** and **Access AI agents**. The Base Role carries neither; **Access AI agents** is what Analytics Chat needs, and neither [forces the Base Role to Developer](#auto-bump-to-developer), so the role stays a Viewer.
  </Step>
  <Step title="Save">
    Click **Create**.
  </Step>
