...
Yes. When using a bring-your-own-model (BYOM) configuration, AI requests bypass
the token quota system entirely — no tokens are consumed or tracked for those
requests.
