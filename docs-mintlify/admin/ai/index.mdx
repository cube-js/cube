...
| `chassis`    | Optimized for semantic-model exploration. Runs a reduced toolset, so some agent features are unavailable, and query results appear inline in the answer rather than as separate tool-call results. |
