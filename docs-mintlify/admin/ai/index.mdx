...
| `chassis`    | Runs a reduced, semantic-model-focused toolset — MCP connector tools and workbook creation are not available — and returns query results inline in the answer rather than as separate tool-call results. |
