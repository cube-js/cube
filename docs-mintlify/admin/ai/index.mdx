...
The `runtime` property applies to chat — [Analytics Chat](/docs/explore-analyze/analytics-chat)
and the [workbook chat sidebar](/docs/explore-analyze/workbooks). [AI summary
