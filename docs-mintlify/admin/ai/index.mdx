...
| `chassis`    | Optimized for semantic-model exploration. Runs a reduced toolset — [MCP connector tools](/admin/ai/mcp-connectors) and some [workbook authoring](/docs/explore-analyze/workbooks/workbook-agent) capabilities are among the features unavailable — and query results appear inline in the answer rather than as separate tool-call results. |
