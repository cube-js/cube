...
exposes, alongside the data it queries from your semantic model. Connector tools are not
available when the agent runs the [`chassis` runtime mode](/admin/ai#runtime).
