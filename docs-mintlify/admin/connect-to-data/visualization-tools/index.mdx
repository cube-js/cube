...
API](/reference/core-data-apis/sql-api).
...
<CardGroup cols={2}>
  <Card title="SQL API" img="https://static.cube.dev/icons/sql.svg" href="/reference/core-data-apis/sql-api">
  </Card>
  <Card title="REST (JSON) API" img="https://static.cube.dev/icons/rest.svg" href="/reference/core-data-apis/rest-api">
  </Card>
  <Card title="GraphQL API" img="https://static.cube.dev/icons/graphql.svg" href="/reference/core-data-apis/graphql-api">
  </Card>
</CardGroup>
