...
<CardGroup cols={3}>
  <Card title="Multitenancy" icon="users-group" href="/admin/connect-to-data/multitenancy">
    Isolate tenants across databases, schemas, and caching layers.
  </Card>
  <Card title="Visualization tools" icon="chart-bar" href="/admin/connect-to-data/visualization-tools">
