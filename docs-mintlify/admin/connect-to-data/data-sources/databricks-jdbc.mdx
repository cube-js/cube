...
To publish deployed Cube views as native Databricks Metric Views, see
[Databricks Metric Views](/docs/integrations/databricks-metric-views). This integration is in preview.
