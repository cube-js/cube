...
To publish deployed Cube views as native Databricks Metric Views, see the
[Databricks Metric Views guide](/docs/integrations/databricks-metric-views). This integration is in
preview.
