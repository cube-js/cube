...
Cube identifies itself to ClickHouse as the client `application` (e.g. `CubeDev_Cube/1.7.37`),
visible alongside your other connections in ClickHouse's session and connection monitoring.
