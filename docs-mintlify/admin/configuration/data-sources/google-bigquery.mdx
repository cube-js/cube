...
description: "In order to connect Google BigQuery to Cube, you need to provide service account credentials. Cube requires the service account to have **BigQuery Data..."
---
...
[`CUBEJS_DB_BQ_CREDENTIALS`](/docs/configuration/reference/environment-variables#cubejs_db_bq_credentials):
...
| ------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- | :------: |
| [`CUBEJS_DB_BQ_PROJECT_ID`](/docs/configuration/reference/environment-variables#cubejs_db_bq_project_id)      | The Google BigQuery project ID to connect to                                                                                                                                                    | A valid Google BigQuery Project ID                                      |    ✅    |
| [`CUBEJS_DB_BQ_KEY_FILE`](/docs/configuration/reference/environment-variables#cubejs_db_bq_key_file)        | The path to a JSON key file for connecting to Google BigQuery                                                                                                                                   | A valid Google BigQuery JSON key file                                   |    ✅    |
| [`CUBEJS_DB_BQ_CREDENTIALS`](/docs/configuration/reference/environment-variables#cubejs_db_bq_credentials)     | A Base64 encoded JSON key file for connecting to Google BigQuery                                                                                                                                | A valid Google BigQuery JSON key file encoded as a Base64 string        |    ❌    |
| [`CUBEJS_DB_BQ_LOCATION`](/docs/configuration/reference/environment-variables#cubejs_db_bq_location)        | The Google BigQuery dataset location to connect to. Required if used with pre-aggregations outside of US. If not set then BQ driver will fail with `Dataset was not found in location US` error | [A valid Google BigQuery regional location][bq-docs-regional-locations] |    ⚠️    |
| [`CUBEJS_DB_EXPORT_BUCKET`](/docs/configuration/reference/environment-variables#cubejs_db_export_bucket)      | The name of a bucket in cloud storage                                                                                                                                                           | A valid bucket name from cloud storage                                  |    ❌    |
| [`CUBEJS_DB_EXPORT_BUCKET_TYPE`](/docs/configuration/reference/environment-variables#cubejs_db_export_bucket_type) | The cloud provider where the bucket is hosted                                                                                                                                                   | `gcp`                                                                   |    ❌    |
| [`CUBEJS_DB_MAX_POOL`](/docs/configuration/reference/environment-variables#cubejs_db_max_pool)           | The maximum number of concurrent database connections to pool. Default is `40`                                                                                                                  | A valid number                                                          |    ❌    |
