---
title: Providing a custom data model for each tenant
description: We have multiple users and we would like them to have different data models. These data models can be completely different or have something in common.
---
...
<Frame>
  <img src="https://ucarecdn.com/f7b311b0-b8d4-4641-92fe-93cd26d2e9b4/" />
</Frame>

And here's the *perspective* of `Bob`:

<Frame>
  <img src="https://ucarecdn.com/4a848cb7-78b3-44c6-9dc8-75a95bbe01db/" />
</Frame>
...
<Frame>
  <img src="https://ucarecdn.com/96efaca8-82e2-45c7-84a8-dc904af53c1a/" />
</Frame>

And here's the generated SQL for `Bob`:

<Frame>
  <img src="https://ucarecdn.com/5fe23769-9e86-440c-88ab-7fe01ed85aee/" />
</Frame>
...
<Frame>
  <img src="https://ucarecdn.com/0789b03a-87f6-49eb-a6ee-79ae87b35d67/" />
</Frame>

And here's the data model and the generated SQL for `Bob`:

<Frame>
  <img src="https://ucarecdn.com/2a07330d-ce18-4e4d-9747-146775ab063a/" />
</Frame>
...
[ref-scheduled-refresh-contexts]: /docs/configuration/reference/config#scheduled_refresh_contexts
[ref-context-to-app-id]: /docs/configuration/reference/config#context_to_app_id
[ref-config-files]: /docs/configuration#cubepy-and-cubejs-files
...
[ref-cube-sql-table]: /docs/data-modeling/reference/cube#sql_table
[ref-cube-data-source]: /docs/data-modeling/reference/cube#data_source
[ref-data-sources]: /docs/configuration/advanced/multiple-data-sources
[ref-cube-extends]: /docs/data-modeling/reference/cube#extends
[ref-dynamic-data-modeling]: /docs/data-modeling/dynamic
[ref-repository-factory]: /docs/configuration/reference/config#repository_factory