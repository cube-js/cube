...
For example, [`CUBEJS_DATASOURCES`](/docs/configuration/reference/environment-variables#cubejs_datasources) defines a list of data sources to connect
...
For example, [`query_rewrite`](/docs/configuration/reference/config#query_rewrite)
...
[`CUBEJS_DEV_MODE`](/docs/configuration/reference/environment-variables#cubejs_dev_mode) environment variable to `true`. Putting Cube in development
...
[link-config]: /docs/configuration/reference/config
[link-dev-playground]: /docs/workspace/playground
[link-env-vars]: /docs/configuration/reference/environment-variables
[link-scheduled-refresh]: /docs/data-modeling/reference/pre-aggregations#scheduled_refresh
...
[ref-cube-package-config]: /docs/data-modeling/reference/cube-package#config-object
[ref-env-var-recipe]: /docs/configuration/recipes/environment-variables