---
title: Retool
description: Retool is the fast way to build internal tools. It lets you visually design apps that interface with any database or API.
---
...
<iframe
  width="100%"
  height="400"
  src="https://www.loom.com/embed/e0f5584068a44df0981372ceac85a21f"
  title="Loom video"
  frameBorder="0"
  allowFullScreen
/>
...
You can connect a Cube deployment to Retool using the [REST API](/api-reference/rest-api).
