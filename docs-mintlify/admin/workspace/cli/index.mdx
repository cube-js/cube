---
description: Use the Cube CLI to create projects, generate data models, and manage Cube deployments from the terminal.
---
...
[ref-ref-cli]: /docs/workspace/cli/reference