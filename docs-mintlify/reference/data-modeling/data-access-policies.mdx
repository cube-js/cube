...
In YAML data models, `if` expressions support the Python boolean operators
`not`, `and`, and `or`. This allows expressing more complex conditions, for
example checking group membership with null safety:
