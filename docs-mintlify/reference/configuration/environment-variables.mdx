...
If `true`, enables [development mode](/docs/data-modeling/dev-mode). It is the only
thing that enables it: development mode is off unless this variable is set to `true`,
and `NODE_ENV` is ignored.
...
It is off by default in [development mode](/docs/data-modeling/dev-mode), that is when
