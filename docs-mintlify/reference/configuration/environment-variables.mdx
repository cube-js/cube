...
creation. When set, it must not be lower than `CUBESTORE_CHUNKS_COUNT_THRESHOLD`,
otherwise compaction would never reduce the number of chunks below this threshold. By
