...
|------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|
| `continueWaitTimeout`                          | Long polling interval in seconds, maximum is 90. The maximum is validated when `orchestrator_options` is an object; a function form is not checked and its value is not clamped                                                                                                                                                                                                                                                                                                                                                   | `10`                    |
