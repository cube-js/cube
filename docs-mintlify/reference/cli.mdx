...
ref can be checked depends only on the ref — paying for a sync first would leave a branch
behind that the failed step can no longer name. Its character set mirrors the CLI's, which
