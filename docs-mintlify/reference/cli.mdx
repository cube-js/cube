...
Data APIs token. A key scoped to the deployment with a role carrying those three covers
every step above; `All` covers it too, at the cost of granting everything else. Its
