...
[ref-rest-query-format]: /reference/rest-api/query-format#query-properties
...
[ref-ref-meta]: /reference/rest-api/reference#base_pathv1meta
...
[ref-ref-rest-api]: /reference/rest-api/reference
