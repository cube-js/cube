...
[ref-sql-api-qpp]: /reference/sql-api/query-format#query-post-processing
[ref-sql-api-qpd]: /reference/sql-api/query-format#query-pushdown
...
[ref-matching-preaggs-time-dimensions]: /docs/caching/matching-pre-aggregations#matching-time-dimensions
[ref-matching-preaggs-ungrouped]: /docs/caching/matching-pre-aggregations#matching-ungrouped-queries
