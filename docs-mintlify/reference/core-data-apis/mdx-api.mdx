---
title: MDX API
description: XMLA/MDX connectivity for Windows Excel PivotTables against Cube Cloud, with preview availability and Enterprise hosting requirements.
---
...
Authentication and authorization work the same as for the [SQL API](/reference/core-data-apis/sql-api/security).
