...
Please [refer to this page](/reference/sql-api/joins) for details
on joins.
...
[ref-queries-wpp]: /reference/queries#query-with-post-processing
[ref-queries-wpd]: /reference/queries#query-with-pushdown
[ref-data-model-concepts]: /docs/data-modeling/concepts
[ref-measure-types]: /reference/data-modeling/measures#type
[ref-query-default-limit]: /reference/queries#row-limit
