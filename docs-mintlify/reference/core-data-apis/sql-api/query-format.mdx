...
Pushdown also works for [views][ref-views] that combine cubes from
[several data sources][ref-multiple-data-sources]: each part of the query is
transpiled and pushed down to the data source it targets.
