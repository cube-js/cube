...
description: "[SQL API][ref-sql-api] supports the following commands as well as functions and operators."
---
...
[ref-qpd]: /reference/sql-api/query-format#query-pushdown
[ref-qpp]: /reference/sql-api/query-format#query-post-processing
[ref-sql-api]: /reference/sql-api
[ref-sql-api-aggregate-functions]: /reference/sql-api/query-format#aggregate-functions
...
[ref-sql-cache-control]: /reference/sql-api#cache-control