...
[ref-cors]: /reference/rest-api#configuration-cors
[graphql]: https://graphql.org
[cube-ea]: https://cube.dev/use-cases/embedded-analytics
[ref-ref-graphql-api]: /reference/graphql-api/reference
[ref-websockets]: /reference/rest-api/real-time-data-fetch#web-sockets
[ref-subscriptions]: /reference/rest-api/real-time-data-fetch#client-subscriptions
[ref-compare-date-range]: /reference/queries#compare-date-range-query
[ref-metadata]: /reference/rest-api/reference#base_pathv1meta
