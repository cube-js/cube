...
**Modules.** Inject [`CubeClientModule` and `CubeClient`](/reference/javascript-sdk/reference/cubejs-client-ngx#api) into your
components and services to get access to `@cubejs-client/core` API.

**Subjects.** Use [RxJS Subject](/reference/javascript-sdk/reference/cubejs-client-ngx#api) and
