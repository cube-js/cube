...
[`QueryBuilder`](/reference/javascript-sdk/reference/cubejs-client-vue#querybuilder) and
[`QueryRenderer`](/reference/javascript-sdk/reference/cubejs-client-vue#queryrenderer) components
...
- **Transform data for visualization.** Use
  [`QueryBuilder`](/reference/javascript-sdk/reference/cubejs-client-vue#querybuilder) and
  [`QueryRenderer`](/reference/javascript-sdk/reference/cubejs-client-vue#queryrenderer) slots
