...
`cache` | [`CacheMode`](/reference/javascript-sdk/reference/cubejs-client-core#types-cache-mode) | Server-side cache policy for query execution. Does not control client-side caching. See [cache control][ref-cache-control] for details on available strategies. | ✅ Yes |
...
Name | Type | Description |
------ | ------ | ------ |
cache? | [`CacheMode`](/reference/javascript-sdk/reference/cubejs-client-core#types-cache-mode) | Server-side cache policy for query execution. Does not control client-side caching. See [cache control][ref-cache-control] for details on available strategies. |
cubeApi | CubeApi | `CubeApi` instance to use |
