...
>  **cube**(**apiToken**: string |  () => *Promise‹string›*, **options**: [CubeApiOptions](#types-cube-js-api-options)): *[CubeApi](#cubeapi)*
...
>  **cube**(**options**: [CubeApiOptions](#types-cube-js-api-options)): *[CubeApi](#cubeapi)*

## `defaultHeuristics`

>  **defaultHeuristics**(**newQuery**: [Query](#query-1), **oldQuery**: [Query](#query-1), **options**: [TDefaultHeuristicsOptions](#tdefaultheuristicsoptions)): *any*

## `defaultOrder`

>  **defaultOrder**(**query**: [Query](#query-1)): *object*
...
> **dryRun**(**query**: [Query](#query-1) | [Query](#query-1)[], **options?**: [LoadMethodOptions](#loadmethodoptions)): *Promise‹[TDryRunResponse](#tdryrunresponse)›*

> **dryRun**(**query**: [Query](#query-1) | [Query](#query-1)[], **options**: [LoadMethodOptions](#loadmethodoptions), **callback?**: [LoadMethodCallback](#loadmethodcallback)‹[TDryRunResponse](#tdryrunresponse)›): *void*

Get query related meta without query execution

### `load`

>  **load**(**query**: [Query](#query-1) | [Query](#query-1)[], **options?**: [LoadMethodOptions](#loadmethodoptions)): *Promise‹[ResultSet](#resultset)›*

>  **load**(**query**: [Query](#query-1) | [Query](#query-1)[], **options?**: [LoadMethodOptions](#loadmethodoptions), **callback?**: [LoadMethodCallback](#loadmethodcallback)‹[ResultSet](#resultset)›): *void*
...
Name | Type | Description |
------ | ------ | ------ |
query | [Query](#query-1) &#124; [Query](#query-1)[] | [Query object][ref-query-format]  |
options? | [LoadMethodOptions](#loadmethodoptions) | - |
callback? | [LoadMethodCallback](#loadmethodcallback)‹[ResultSet](#resultset)› | - |

### `meta`

>  **meta**(**options?**: [LoadMethodOptions](#loadmethodoptions)): *Promise‹[Meta](#meta-1)›*

>  **meta**(**options?**: [LoadMethodOptions](#loadmethodoptions), **callback?**: [LoadMethodCallback](#loadmethodcallback)‹[Meta](#meta-1)›): *void*

Get meta description of cubes available for querying.

### `sql`

>  **sql**(**query**: [Query](#query-1) | [Query](#query-1)[], **options?**: [LoadMethodOptions](#loadmethodoptions)): *Promise‹[SqlQuery](#sqlquery)›*

>  **sql**(**query**: [Query](#query-1) | [Query](#query-1)[], **options?**: [LoadMethodOptions](#loadmethodoptions), **callback?**: [LoadMethodCallback](#loadmethodcallback)‹[SqlQuery](#sqlquery)›): *void*
...
>  **subscribe**(**query**: [Query](#query-1) | [Query](#query-1)[], **options**: [LoadMethodOptions](#loadmethodoptions) | null, **callback**: [LoadMethodCallback](#loadmethodcallback)‹[ResultSet](#resultset)›): *void*
...
>  **membersForQuery**(**query**: [Query](#query-1) | null, **memberType**: [MemberType](#membertype)): *[TCubeMeasure](#tcubemeasure)[] | [TCubeDimension](#tcubedimension)[] | [TCubeMember](#tcubemember)[]*
...
Name | Type | Description |
------ | ------ | ------ |
query | [Query](#query-1) &#124; null | context query to provide filtering of members available to add to this query  |
...
>  **drillDown**(**drillDownLocator**: [DrillDownLocator](#drilldownlocator), **pivotConfig?**: [PivotConfig](#pivotconfig)): *[Query](#query-1) | null*
...
>  **series**‹**SeriesItem**›(**pivotConfig?**: [PivotConfig](#pivotconfig)): *[Series](#series-1)‹SeriesItem›[]*
...
> **PivotQuery**: *[Query](#query-1) & object*
...
Name | Type |
------ | ------ |
dimensions | Record‹string, [Annotation](#annotation-1)› |
measures | Record‹string, [Annotation](#annotation-1)› |
timeDimensions | Record‹string, [Annotation](#annotation-1)› |
...
Name | Type |
------ | ------ |
normalizedQueries | [Query](#query-1)[] |
pivotQuery | [PivotQuery](#pivotquery) |
