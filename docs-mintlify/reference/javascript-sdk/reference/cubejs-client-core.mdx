...
`baseRequestId` | `string` | ✅ Yes | Base request ID ([`spanId`](/reference/core-data-apis/rest-api#request-span-annotation)) to be used for the request. If not provided a random request ID will be generated. |
