...
description: Recipe for powering filter dropdowns by querying distinct dimension values from Cube’s data APIs on a users-by-city example.
---
...
[dimensions](/reference/data-modeling/dimensions).
...
[`/meta` endpoint](/reference/rest-api/reference#base_pathv1meta):
