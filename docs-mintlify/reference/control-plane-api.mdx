...
description: REST surface for automating Cube Cloud deployments, environments, JWT issuance, audit log export, and dashboard PDF/PNG export.
---
...
bypass that setting the way a built-in scheduled notification does. See the
[API reference][ref-api-reference] for the full request and response schema.
