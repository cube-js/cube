...
action uses — without driving a browser through the console. The endpoint
renders the on-screen layout only; the [print version][ref-print-version] is
not available here. A draft that has never been published can't be exported. Identify the dashboard with either
...
[ref-print-version]: /docs/explore-analyze/dashboards#print-version
