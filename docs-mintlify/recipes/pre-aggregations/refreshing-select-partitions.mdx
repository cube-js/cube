...
[partitioning](/docs/pre-aggregations/using-pre-aggregations#partitioning) by time to
...
with the [`FITER_PARAMS`](/reference/data-modeling/context-variables#filter_params)
...
[`FILTER_PARAMS`](/reference/data-modeling/context-variables#filter_params) for that!
