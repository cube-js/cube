...
<CardGroup cols={3}>
  ...
  <Card title="Databricks OAuth authentication" icon="fingerprint" href="/recipes/configuration/databricks-oauth-authentication">
    Use per-user OAuth tokens from Databricks with a service account fallback for liveness checks.
  </Card>
</CardGroup>
