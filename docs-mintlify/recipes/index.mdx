...
<CardGroup cols={3}>
  ...
  <Card title="FX rates rollup join" icon="coins" href="/recipes/pre-aggregations/fx-rates-rollup-join">
    Combine a slow-changing fact rollup with a frequently-refreshed FX rates rollup for fresh currency-converted metrics.
  </Card>
</CardGroup>
