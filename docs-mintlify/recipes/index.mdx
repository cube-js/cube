...
<CardGroup cols={3}>
  ...
  <Card title="Reusable period-to-date logic" icon="calendar-stats" href="/recipes/data-modeling/reusable-period-to-date">
...
<CardGroup cols={3}>
  ...
  <Card title="Multi-stage measures" icon="layer-group" href="/recipes/pre-aggregations/matching-multi-stage-measures">
