...
<CardGroup cols={3}>
  ...
  <Card title="Per-user OAuth authentication" icon="fingerprint" href="/recipes/configuration/oauth-authentication">
    Authenticate each user with their own OAuth token for Databricks, Snowflake, or other OAuth-capable sources.
  </Card>
</CardGroup>
