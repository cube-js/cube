---
title: Calculating period-over-period changes
description: Often, there's a need to calculate a period-over-period change in a metric, e.g., week-over-week or month-over-month growth of clicks, orders, revenue, etc.
---
...
<Frame>
  <img src="https://lgo0ecceic.ucarecd.net/2f97cb29-903c-41ff-99e3-295535d2844f/" />
</Frame>
...
[ref-time-dimension-granularity]: /reference/core-data-apis/rest-api/query-format#time-dimensions-format
