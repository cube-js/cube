...
calculations][ref-multi-stage-calculations]. For the function's arguments, the
algorithm it uses, and how it behaves on edge cases, see the
[XIRR function reference][ref-xirr-function].
...
[ref-xirr-function]: /reference/core-data-apis/xirr
