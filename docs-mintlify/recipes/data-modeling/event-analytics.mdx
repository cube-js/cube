...
description: Turn raw clickstream events into session definitions and metrics you control, using SQL-based patterns that work across common event pipelines.
---
...
[declare a join](/reference/data-modeling/joins) such that the `events`
