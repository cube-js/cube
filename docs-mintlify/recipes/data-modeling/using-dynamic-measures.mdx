...
description: Generate measures programmatically from changing reference data so distribution and percentage metrics stay in sync without hand-editing each value.
---
